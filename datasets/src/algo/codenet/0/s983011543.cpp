...
signed main(){
	...
	else printf("%lld",min(min(min(a2[n][0],a2[n][1]),a1[n][1])*(m-1)+min(a1[n][1],a1[n][0]),a2[n][1]*((int)((m-1)/2))+min(a1[n][0],a1[n][1])*((int)((m+1)/2))));
	return 0;
} 