...
int main(int argc,char **argv){
	...
	in.scan();
	int c[3][3];
	for(int i=0;i<3;++i) in.get(c[i],3);
	out<(c[0][1]-c[0][0]==c[1][1]-c[1][0]&&c[1][1]-c[1][0]==c[2][1]-c[2][0]&&c[0][2]-c[0][1]==c[1][2]-c[1][1]&&c[1][2]-c[1][1]==c[2][2]-c[2][1]&&c[1][0]-c[0][0]==c[1][1]-c[0][1]&&c[1][1]-c[0][1]==c[1][2]-c[0][2]&&c[2][0]-c[1][0]==c[2][1]-c[1][1]&&c[2][1]-c[1][1]==c[2][2]-c[1][2]?"Yes":"No")<'\n';
	out.print();
	in.close();
	out.close();
	return 0;
