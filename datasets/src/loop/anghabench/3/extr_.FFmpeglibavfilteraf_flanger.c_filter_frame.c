...
struct TYPE_14__ {int nb_samples; int /*<<< orphan*/ ** extended_data; } ;
struct TYPE_13__ {int delay_buf_pos; int max_samples; int lfo_length; int channel_phase; double* lfo; int lfo_pos; double* delay_last; double feedback_gain; scalar_t__ interpolation; double in_gain; double delay_gain; int /*<<< orphan*/ ** delay_buffer; } ;
