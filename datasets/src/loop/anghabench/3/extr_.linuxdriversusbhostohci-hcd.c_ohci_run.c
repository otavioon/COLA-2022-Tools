...
struct ohci_hcd {int fminterval; int hc_control; int flags; int hcca_dma; int /*<<< orphan*/  lock; scalar_t__ next_statechange; TYPE_3__* regs; int /*<<< orphan*/  rh_state; int /*<<< orphan*/  hcca; } ;
