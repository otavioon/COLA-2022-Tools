...
struct f2fs_map_blocks {unsigned int m_len; int m_flags; int m_lblk; scalar_t__ m_pblk; unsigned int* m_next_extent; unsigned int* m_next_pgofs; int /*<<< orphan*/  m_seg_type; } ;
