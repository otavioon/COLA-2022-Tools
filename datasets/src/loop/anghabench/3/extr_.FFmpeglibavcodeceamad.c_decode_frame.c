...
typedef  int int64_t ;
struct TYPE_20__ {int /*<<< orphan*/  num; int /*<<< orphan*/  den; } ;
struct TYPE_25__ {int width; int height; TYPE_1__ framerate; TYPE_3__* priv_data; } ;
struct TYPE_24__ {int height; int* linesize; int /*<<< orphan*/ ** data; } ;
struct TYPE_23__ {int size; int /*<<< orphan*/ * data; } ;
struct TYPE_21__ {int /*<<< orphan*/  (* bswap16_buf ) (int /*<<< orphan*/ *,int /*<<< orphan*/  const*,int) ;} ;
struct TYPE_22__ {int mb_y; int mb_x; TYPE_5__* last_frame; int /*<<< orphan*/ * bitstream_buf; int /*<<< orphan*/  gb; TYPE_2__ bbdsp; int /*<<< orphan*/  bitstream_buf_size; } ;
