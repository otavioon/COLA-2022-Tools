...
/* Type definitions */
struct statx {int stx_mask; int stx_size; int stx_blocks; int stx_blksize; int stx_mode; int stx_dev_major; int stx_dev_minor; int stx_ino; int stx_nlink; int stx_rdev_major; int stx_rdev_minor; int stx_uid; int stx_gid; int stx_attributes_mask; int stx_attributes; int /*<<< orphan*/  stx_btime; int /*<<< orphan*/  stx_ctime; int /*<<< orphan*/  stx_mtime; int /*<<< orphan*/  stx_atime; } ;
