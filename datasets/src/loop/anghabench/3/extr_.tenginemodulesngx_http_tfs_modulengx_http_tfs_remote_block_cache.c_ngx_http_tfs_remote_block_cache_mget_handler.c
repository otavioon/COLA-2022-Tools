...
struct TYPE_31__ {size_t segment_index; scalar_t__ segment_count; int /*<<< orphan*/  curr_batch_count; TYPE_8__* segment_data; } ;
struct TYPE_29__ {int use_cache; int /*<<< orphan*/  local_ctx; } ;
struct TYPE_32__ {int /*<<< orphan*/  log; int /*<<< orphan*/  decline_handler; TYPE_6__ file; int /*<<< orphan*/  pool; int /*<<< orphan*/  name_server_addr_text; TYPE_4__ block_cache_ctx; int /*<<< orphan*/  data; } ;
typedef  TYPE_7__ ngx_http_tfs_t ;
struct TYPE_30__ {scalar_t__ block_id; } ;
struct TYPE_28__ {int /*<<< orphan*/ * ds_addrs; scalar_t__ ds_count; } ;
struct TYPE_33__ {TYPE_5__ segment_info; int /*<<< orphan*/  cache_hit; TYPE_3__ block_info; } ;
...
struct TYPE_22__ {int /*<<< orphan*/ * ds_addrs; scalar_t__ ds_count; } ;
typedef  TYPE_10__ ngx_http_tfs_block_cache_value_t ;
struct TYPE_23__ {scalar_t__ block_id; int /*<<< orphan*/  ns_addr; } ;
typedef  TYPE_11__ ngx_http_tfs_block_cache_key_t ;
struct TYPE_26__ {int /*<<< orphan*/ * data; } ;
struct TYPE_24__ {scalar_t__ rc; TYPE_2__* value; TYPE_1__ key; } ;
typedef  TYPE_12__ ngx_http_tair_key_value_t ;
struct TYPE_25__ {scalar_t__ nelts; TYPE_12__* elts; } ;
