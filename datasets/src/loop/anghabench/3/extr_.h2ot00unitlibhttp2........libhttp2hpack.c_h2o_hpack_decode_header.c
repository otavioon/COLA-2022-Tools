...
struct TYPE_19__ {scalar_t__ len; int /*<<< orphan*/  base; } ;
typedef  TYPE_2__ h2o_iovec_t ;
struct TYPE_20__ {scalar_t__ hpack_max_capacity; size_t hpack_capacity; scalar_t__ num_entries; size_t hpack_size; } ;
