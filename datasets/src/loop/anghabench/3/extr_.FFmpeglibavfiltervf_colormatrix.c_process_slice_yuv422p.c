...
/* Type definitions */
struct TYPE_4__ {int c2; int c3; int c4; int c5; int c6; int c7; TYPE_2__* dst; TYPE_2__* src; } ;
typedef  TYPE_1__ ThreadData ;
struct TYPE_5__ {int height; int width; int* linesize; unsigned char** data; } ;
