...
/* Variables and functions */
 ...
 int /*<<< orphan*/  SLDI_B2_SB (scalar_t__,scalar_t__,scalar_t__,scalar_t__,int,int,int) ; 
...
__attribute__((used)) static void hevc_sao_edge_filter_45degree_16multiple_msa(uint8_t *dst,
                                                         int32_t dst_stride,
                                                         uint8_t *src,
                                                         int32_t src_stride,
                                                         int16_t *
