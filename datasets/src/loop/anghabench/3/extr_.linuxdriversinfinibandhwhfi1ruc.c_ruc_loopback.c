...
struct rvt_sge {scalar_t__ length; scalar_t__ sge_length; scalar_t__ n; scalar_t__ m; TYPE_12__* mr; int /*<<< orphan*/ * vaddr; } ;
...
struct TYPE_24__ {scalar_t__ length; int /*<<< orphan*/ * vaddr; } ;
...
#define  IB_WR_SEND_WITH_INV 128 
 ...
 int /*<<< orphan*/  hfi1_copy_sge (TYPE_11__*,int /*<<< orphan*/ *,scalar_t__,int,int) ; 
