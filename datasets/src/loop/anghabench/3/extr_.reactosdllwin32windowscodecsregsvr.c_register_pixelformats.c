...
/* Type definitions */
struct regsvr_pixelformat {int bitsperpixel; size_t channelcount; int /*<<< orphan*/  const** channelmasks; int /*<<< orphan*/  supportsalpha; int /*<<< orphan*/  numericrepresentation; int /*<<< orphan*/ * version; int /*<<< orphan*/ * vendor; int /*<<< orphan*/ * friendlyname; int /*<<< orphan*/ * author; int /*<<< orphan*/ * clsid; } ;
typedef  char WCHAR ;
typedef  size_t UINT ;
