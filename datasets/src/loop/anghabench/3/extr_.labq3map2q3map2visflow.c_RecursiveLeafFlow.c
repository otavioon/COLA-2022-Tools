...
struct TYPE_19__ {scalar_t__ status; float radius; int leaf; TYPE_2__ plane; void* winding; int /*<<< orphan*/  origin; int /*<<< orphan*/ * portalflood; int /*<<< orphan*/ * portalvis; scalar_t__ removed; } ;
