...
struct TYPE_7__ {TYPE_3__* in; TYPE_3__* out; } ;
typedef  TYPE_1__ ThreadData ;
struct TYPE_10__ {TYPE_2__* priv; } ;
struct TYPE_9__ {int* linesize; int /*<<< orphan*/ ** data; } ;
struct TYPE_8__ {int nb_planes; int bpc; int* threshold; int* planeheight; int* planewidth; int /*<<< orphan*/  max; int /*<<< orphan*/  coordinates; int /*<<< orphan*/  (* filter ) (int /*<<< orphan*/ *,int /*<<< orphan*/  const*,int,int const,int /*<<< orphan*/  const**,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ;} ;
