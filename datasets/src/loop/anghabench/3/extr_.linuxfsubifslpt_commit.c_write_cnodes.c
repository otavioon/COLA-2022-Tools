...
/* Variables and functions */
 ...
 int ubifs_leb_write (struct ubifs_info*,int,int /*<<< orphan*/ *,int,int) ; 
 int /*<<< orphan*/  ubifs_pack_lsave (struct ubifs_info*,int /*<<< orphan*/ *,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  ubifs_pack_ltab (struct ubifs_info*,int /*<<< orphan*/ *,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  ubifs_pack_nnode (struct ubifs_info*,int /*<<< orphan*/ *,struct ubifs_nnode*) ; 
 int /*<<< orphan*/  ubifs_pack_pnode (struct ubifs_info*,int /*<<< orphan*/ *,struct ubifs_pnode*) ; 
