...
struct TYPE_21__ {int* tried; TYPE_9__* peers; TYPE_2__* current; } ;
struct TYPE_17__ {size_t len; int /*<<< orphan*/ * data; } ;
struct TYPE_19__ {int tries; int (* get_rr_peer ) (TYPE_4__*,TYPE_6__*) ;scalar_t__ rehash; int hash; TYPE_6__ rrp; TYPE_1__ key; } ;
typedef  TYPE_3__ ngx_stream_upstream_hash_peer_data_t ;
struct TYPE_20__ {int /*<<< orphan*/ * name; int /*<<< orphan*/  socklen; int /*<<< orphan*/  sockaddr; int /*<<< orphan*/  log; int /*<<< orphan*/ * connection; int /*<<< orphan*/  tries; } ;
typedef  TYPE_4__ ngx_peer_connection_t ;
typedef  int ngx_int_t ;
struct TYPE_22__ {int total_weight; TYPE_2__* peer; scalar_t__ single; } ;
