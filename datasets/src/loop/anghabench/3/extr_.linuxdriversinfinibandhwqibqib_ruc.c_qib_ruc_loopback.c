...
struct rvt_sge {scalar_t__ length; scalar_t__ sge_length; scalar_t__ n; scalar_t__ m; TYPE_14__* mr; int /*<<< orphan*/ * vaddr; } ;
...
struct TYPE_30__ {scalar_t__ length; int /*<<< orphan*/ * vaddr; } ;
...
#define  IB_WR_SEND_WITH_IMM 128 
 ...
 int /*<<< orphan*/  qib_copy_sge (TYPE_13__*,int /*<<< orphan*/ *,scalar_t__,int) ; 
