...
struct TYPE_33__ {int saw_first_ts; int dts; scalar_t__ pts; scalar_t__ next_dts; scalar_t__ next_pts; int got_output; TYPE_2__* dec_ctx; TYPE_22__* st; TYPE_24__ framerate; scalar_t__ decoding_needed; int /*<<< orphan*/  file_index; } ;
