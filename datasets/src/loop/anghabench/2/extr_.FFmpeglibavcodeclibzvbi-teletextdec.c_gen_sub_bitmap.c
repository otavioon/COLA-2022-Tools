...
struct TYPE_17__ {int* linesize; int w; int h; int nb_colors; int /*<<< orphan*/  type; int /*<<< orphan*/ ** data; scalar_t__ y; int /*<<< orphan*/  x; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  vbi_draw_vt_page_region (TYPE_1__*,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int,int,int,int,int) ; 
