...
struct TYPE_17__ {int width; int height; int* linesize; int key_frame; scalar_t__* data; int /*<<< orphan*/  pict_type; int /*<<< orphan*/  format; } ;
struct TYPE_16__ {int size; int /*<<< orphan*/ * data; } ;
struct TYPE_15__ {int tff; scalar_t__ interlace; TYPE_10__* mjpeg_avctx; scalar_t__ is_mjpeg; } ;
struct TYPE_14__ {int /*<<< orphan*/  pix_fmt; } ;
...
/* Variables and functions */
 ...
 int avcodec_decode_video2 (TYPE_10__*,TYPE_3__*,int*,TYPE_2__*) ; 
