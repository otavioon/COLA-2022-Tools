...
struct mmap_args {int fd; int addr; int len; int prot; int flags; int pos; } ;
...
struct TYPE_7__ {int fg_flag; int /*<<< orphan*/ * fg_data; } ;
...
#define  KERN_SUCCESS 128 
 ...
 int vm_map_enter_mem_object (int /*<<< orphan*/ ,int*,int,int /*<<< orphan*/ ,int,TYPE_1__,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ,void*,int,int,int /*<<< orphan*/ ) ; 
 int vm_map_enter_mem_object_control (int /*<<< orphan*/ ,int*,int,int /*<<< orphan*/ ,int,TYPE_1__,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int,void*,int,int,int /*<<< orphan*/ ) ; 
 int vm_map_page_mask (int /*<<< orphan*/ ) ; 
