...
/* Type definitions */
struct TYPE_25__ {int NatDoCancelFlag; scalar_t__ Now; int /*<<< orphan*/ * TmpBuf; int /*<<< orphan*/  SockEvent; scalar_t__ IcmpRawSocketOk; } ;
typedef  TYPE_1__ VH ;
...
struct TYPE_29__ {int DataSize; int /*<<< orphan*/ * Data; int /*<<< orphan*/  IpAddress; scalar_t__ Ok; } ;
...
/* Variables and functions */
 ...
 TYPE_4__* IcmpParseResult (int /*<<< orphan*/ *,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ *,scalar_t__) ; 
 ...
 TYPE_5__* NewBlock (int /*<<< orphan*/ *,scalar_t__,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/ * NewThread (int /*<<< orphan*/ ,TYPE_2__*) ; 
 TYPE_6__* NewUDP (int /*<<< orphan*/ ) ; 
 scalar_t__ RecvFrom (TYPE_6__*,int /*<<< orphan*/ *,scalar_t__*,int /*<<< orphan*/ *,int) ; 
