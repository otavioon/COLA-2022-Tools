...
struct TYPE_42__ {int x1; int x0; int y1; int y0; int numcomps; TYPE_1__* comps; } ;
typedef  TYPE_3__ opj_image_t ;
typedef  int /*<<< orphan*/  opj_codec_t ;
struct TYPE_43__ {TYPE_9__* f; } ;
typedef  TYPE_4__ ThreadFrame ;
struct TYPE_48__ {int key_frame; int /*<<< orphan*/  pict_type; } ;
struct TYPE_47__ {char* data; int size; } ;
struct TYPE_46__ {TYPE_2__* comp; } ;
struct TYPE_45__ {int member_1; char* member_2; int /*<<< orphan*/  member_0; } ;
struct TYPE_39__ {int /*<<< orphan*/  cp_reduce; int /*<<< orphan*/  cp_layer; } ;
struct TYPE_44__ {TYPE_12__ dec_params; int /*<<< orphan*/  lowqual; } ;
struct TYPE_41__ {int step; } ;
struct TYPE_40__ {scalar_t__ prec; int /*<<< orphan*/  data; } ;
struct TYPE_38__ {scalar_t__ bits_per_raw_sample; int /*<<< orphan*/  pix_fmt; int /*<<< orphan*/  lowres; TYPE_5__* priv_data; } ;
