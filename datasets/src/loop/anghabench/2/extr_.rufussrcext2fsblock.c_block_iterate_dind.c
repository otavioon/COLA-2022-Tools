...
/* Type definitions */
struct block_context {int flags; int (* func ) (TYPE_1__*,scalar_t__*,int /*<<< orphan*/ ,scalar_t__,int,int /*<<< orphan*/ ) ;int bcount; int /*<<< orphan*/  priv_data; TYPE_1__* fs; scalar_t__ errcode; int /*<<< orphan*/ * dind_buf; } ;
