...
/* Type definitions */
struct block_context {int flags; int (* func ) (TYPE_1__*,scalar_t__*,scalar_t__,scalar_t__,int,int /*<<< orphan*/ ) ;int /*<<< orphan*/  priv_data; TYPE_1__* fs; scalar_t__ errcode; int /*<<< orphan*/ * ind_buf; scalar_t__ bcount; } ;
...
/* Variables and functions */
 ...
 scalar_t__ ext2fs_read_ind_block (TYPE_1__*,scalar_t__,int /*<<< orphan*/ *) ; 
 scalar_t__ ext2fs_write_ind_block (TYPE_1__*,scalar_t__,int /*<<< orphan*/ *) ; 
