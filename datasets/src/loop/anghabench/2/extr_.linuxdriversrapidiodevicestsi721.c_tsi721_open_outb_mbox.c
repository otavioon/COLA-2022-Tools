...
struct TYPE_3__ {int size; int* omq_phys; int omd_phys; int sts_size; int sts_phys; struct tsi721_omsg_desc** omq_base; struct tsi721_omsg_desc* omd_base; scalar_t__ wr_count; int /*<<< orphan*/ * sts_base; scalar_t__ tx_slot; int /*<<< orphan*/  lock; scalar_t__ sts_rdptr; int /*<<< orphan*/ * dev_id; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  dma_free_coherent (int /*<<< orphan*/ *,int,struct tsi721_omsg_desc*,int) ; 
