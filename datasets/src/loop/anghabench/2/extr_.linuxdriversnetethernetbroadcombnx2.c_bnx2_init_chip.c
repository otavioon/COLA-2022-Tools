...
typedef  int u32 ;
typedef  int u16 ;
struct bnx2 {int flags; int bus_speed_mhz; int* mac_addr; int idle_chk_status_idx; int status_blk_mapping; int stats_blk_mapping; int tx_quick_cons_trip_int; int tx_quick_cons_trip; int rx_quick_cons_trip_int; int rx_quick_cons_trip; int comp_prod_trip_int; int comp_prod_trip; int tx_ticks_int; int tx_ticks; int rx_ticks_int; int rx_ticks; int com_ticks_int; int com_ticks; int cmd_ticks_int; int cmd_ticks; int stats_ticks; int irq_nvecs; void* hc_cmd; TYPE_3__* dev; TYPE_2__* bnx2_napi; int /*<<< orphan*/  status_stats_size; scalar_t__ pcix_cap; int /*<<< orphan*/  pdev; } ;
