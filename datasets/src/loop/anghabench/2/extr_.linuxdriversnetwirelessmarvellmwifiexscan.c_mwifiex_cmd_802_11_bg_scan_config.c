...
struct mwifiex_bg_scan_cfg {int action; int num_probes; int repeat_count; int rssi_threshold; int num_ssids; int start_later; TYPE_1__* chan_list; TYPE_10__* ssid_list; int /*<<< orphan*/  chan_per_scan; int /*<<< orphan*/  report_condition; int /*<<< orphan*/  scan_interval; int /*<<< orphan*/  bss_type; int /*<<< orphan*/  enable; } ;
struct host_cmd_ds_802_11_bg_scan_config {int* tlv; int /*<<< orphan*/  chan_per_scan; int /*<<< orphan*/  enable; void* report_condition; void* scan_interval; int /*<<< orphan*/  bss_type; void* action; } ;
...
struct TYPE_18__ {int scan_probes; size_t passive_scan_time; size_t specific_scan_time; int /*<<< orphan*/  dev; } ;
struct TYPE_14__ {size_t scan_type; int scan_time; int /*<<< orphan*/  radio_type; scalar_t__ chan_number; } ;
