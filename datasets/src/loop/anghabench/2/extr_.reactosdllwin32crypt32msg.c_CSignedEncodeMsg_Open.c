...
/* Type definitions */
struct TYPE_23__ {int cSignerInfo; int /*<<< orphan*/  rgCrlEncoded; int /*<<< orphan*/  cCrlEncoded; int /*<<< orphan*/  rgCertEncoded; int /*<<< orphan*/  cCertEncoded; int /*<<< orphan*/ * signerKeySpec; struct TYPE_23__* rgSignerInfo; int /*<<< orphan*/  version; } ;
struct TYPE_22__ {int cbSize; size_t cSigners; int /*<<< orphan*/  rgCrlEncoded; int /*<<< orphan*/  cCrlEncoded; int /*<<< orphan*/  rgCertEncoded; int /*<<< orphan*/  cCertEncoded; TYPE_10__* rgSigners; scalar_t__ cAttrCertEncoded; } ;
struct TYPE_18__ {TYPE_6__* info; scalar_t__ cSignerHandle; int /*<<< orphan*/ * signerHandles; } ;
struct TYPE_19__ {int /*<<< orphan*/ * pbData; scalar_t__ cbData; } ;
struct TYPE_21__ {TYPE_11__ msg_data; TYPE_1__ data; int /*<<< orphan*/ * innerOID; } ;
struct TYPE_20__ {scalar_t__ dwIdChoice; } ;
struct TYPE_17__ {int /*<<< orphan*/  dwKeySpec; int /*<<< orphan*/  hCryptProv; TYPE_2__ SignerId; } ;
