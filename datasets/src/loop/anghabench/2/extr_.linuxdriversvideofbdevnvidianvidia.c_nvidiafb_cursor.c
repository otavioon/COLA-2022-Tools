...
struct TYPE_6__ {int width; int height; int dy; int dx; int bg_color; int fg_color; int /*<<< orphan*/ * data; } ;
struct fb_cursor {int set; int rop; scalar_t__ enable; TYPE_3__ image; int /*<<< orphan*/ * mask; } ;
