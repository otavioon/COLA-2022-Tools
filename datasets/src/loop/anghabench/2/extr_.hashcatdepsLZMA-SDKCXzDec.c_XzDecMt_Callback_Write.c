...
struct TYPE_16__ {scalar_t__ inCodeSize; size_t outCodeSize; size_t outPreSize; int status; scalar_t__ codeRes; scalar_t__ inPreSize; scalar_t__ blockPackTotal; scalar_t__ parseState; scalar_t__ parsing_Truncated; int /*<<< orphan*/  blockPackSize_for_Index; TYPE_2__ dec; int /*<<< orphan*/  streamFlags; int /*<<< orphan*/ * outBuf; } ;
