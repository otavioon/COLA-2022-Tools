...
struct TYPE_44__ {int complete_lengths; int complete_values; TYPE_26__* file; int /*<<< orphan*/ * syslog_peer; TYPE_3__* script; int /*<<< orphan*/ * complex_value; int /*<<< orphan*/ * filter; TYPE_13__* value; TYPE_14__* cf; TYPE_10__* format; scalar_t__ variables; int /*<<< orphan*/ * values; int /*<<< orphan*/ * lengths; TYPE_13__* source; } ;
typedef  TYPE_6__ ngx_stream_script_compile_t ;
typedef  TYPE_6__ ngx_stream_log_t ;
struct TYPE_45__ {int off; int /*<<< orphan*/ * logs; } ;
typedef  TYPE_8__ ngx_stream_log_srv_conf_t ;
typedef  int /*<<< orphan*/  ngx_stream_log_script_t ;
struct TYPE_37__ {scalar_t__ nelts; TYPE_10__* elts; } ;
struct TYPE_46__ {TYPE_1__ formats; } ;
typedef  TYPE_9__ ngx_stream_log_main_conf_t ;
struct TYPE_40__ {scalar_t__ len; int /*<<< orphan*/  data; } ;
struct TYPE_33__ {TYPE_2__ name; } ;
typedef  TYPE_10__ ngx_stream_log_fmt_t ;
struct TYPE_34__ {scalar_t__ flush; scalar_t__ gzip; TYPE_4__* event; int /*<<< orphan*/ * start; int /*<<< orphan*/ * last; int /*<<< orphan*/ * pos; } ;
...
struct TYPE_35__ {char* data; scalar_t__ len; } ;
...
struct TYPE_43__ {int nelts; TYPE_13__* elts; } ;
...
struct TYPE_38__ {TYPE_11__* data; int /*<<< orphan*/  flush; } ;
...
/* Variables and functions */
 ...
 scalar_t__ ngx_conf_full_name (TYPE_27__*,TYPE_13__*,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  ngx_conf_log_error (int /*<<< orphan*/ ,TYPE_14__*,int /*<<< orphan*/ ,char*,...) ; 
 TYPE_26__* ngx_conf_open_file (TYPE_27__*,TYPE_13__*) ; 
