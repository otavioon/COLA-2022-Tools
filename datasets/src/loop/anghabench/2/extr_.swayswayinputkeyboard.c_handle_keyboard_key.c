...
struct wlr_event_keyboard_key {int keycode; scalar_t__ state; int /*<<< orphan*/  time_msec; } ;
...
/* Variables and functions */
 ...
 int keyboard_execute_compositor_binding (struct sway_keyboard*,int const*,int /*<<< orphan*/ ,size_t) ; 
 int /*<<< orphan*/  keyboard_key ; 
 size_t keyboard_keysyms_raw (struct sway_keyboard*,int,int const**,int /*<<< orphan*/ *) ; 
 size_t keyboard_keysyms_translated (struct sway_keyboard*,int,int const**,int /*<<< orphan*/ *) ; 
 ...
 int /*<<< orphan*/  wlr_seat_keyboard_notify_key (struct wlr_seat*,int /*<<< orphan*/ ,int,scalar_t__) ; 
