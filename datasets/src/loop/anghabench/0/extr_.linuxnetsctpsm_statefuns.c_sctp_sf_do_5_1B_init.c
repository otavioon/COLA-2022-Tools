...
/* Variables and functions */
 ...
 struct sctp_packet* sctp_abort_pkt_new (struct net*,struct sctp_endpoint const*,struct sctp_association const*,struct sctp_chunk*,int /*<<< orphan*/ *,int) ; 
 ...
 int sctp_sf_pdiscard (struct net*,struct sctp_endpoint const*,struct sctp_association const*,union sctp_subtype const,struct sctp_chunk*,struct sctp_cmd_seq*) ; 
 int sctp_sf_tabort_8_4_8 (struct net*,struct sctp_endpoint const*,struct sctp_association const*,union sctp_subtype const,struct sctp_chunk*,struct sctp_cmd_seq*) ; 
