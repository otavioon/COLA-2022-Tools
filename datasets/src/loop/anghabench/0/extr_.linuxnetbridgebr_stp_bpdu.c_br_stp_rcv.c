...
struct net_bridge_port {scalar_t__ state; int flags; int port_no; struct net_bridge* br; TYPE_2__* dev; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  br_notice (struct net_bridge*,char*,int,int /*<<< orphan*/ ,...) ; 
