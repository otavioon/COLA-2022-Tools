...
struct TYPE_18__ {scalar_t__ early_data_state; scalar_t__ hello_retry_request; scalar_t__ server; TYPE_4__ s3; int /*<<< orphan*/ * early_secret; TYPE_2__* session; } ;
struct TYPE_15__ {scalar_t__ max_early_data; } ;
struct TYPE_17__ {int /*<<< orphan*/  master_key_length; int /*<<< orphan*/  master_key; int /*<<< orphan*/ * early_secret; TYPE_3__ ext; } ;
...
/* Variables and functions */
 long BIO_get_mem_data (int /*<<< orphan*/ ,unsigned char const**) ; 
