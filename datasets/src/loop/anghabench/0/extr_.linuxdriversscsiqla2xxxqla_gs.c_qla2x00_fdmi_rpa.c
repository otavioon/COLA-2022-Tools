...
struct TYPE_24__ {struct ct_fdmi_port_attr* port_name; TYPE_5__ attrs; } ;
...
#define  PORT_SPEED_8GB 128 
 ...
 int /*<<< orphan*/  memcpy (struct ct_fdmi_port_attr*,int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  ql_dbg (scalar_t__,TYPE_9__*,int,char*,...) ; 
 scalar_t__ ql_dbg_buffer ; 
 scalar_t__ ql_dbg_disc ; 
 int /*<<< orphan*/  ql_dump_buffer (scalar_t__,TYPE_9__*,int,struct ct_fdmi_port_attr*,int) ; 
 ...
 int /*<<< orphan*/  wwn_to_u64 (struct ct_fdmi_port_attr*) ; 
