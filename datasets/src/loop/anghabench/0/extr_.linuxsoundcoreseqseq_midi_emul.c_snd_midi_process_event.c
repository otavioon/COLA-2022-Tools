...
struct snd_midi_op {int /*<<< orphan*/  (* control ) (int /*<<< orphan*/ *,int /*<<< orphan*/ ,struct snd_midi_channel*) ;int /*<<< orphan*/  (* key_press ) (int /*<<< orphan*/ *,size_t,scalar_t__,struct snd_midi_channel*) ;int /*<<< orphan*/  (* note_off ) (int /*<<< orphan*/ *,size_t,int /*<<< orphan*/ ,struct snd_midi_channel*) ;int /*<<< orphan*/  (* note_on ) (int /*<<< orphan*/ *,size_t,scalar_t__,struct snd_midi_channel*) ;} ;
struct snd_midi_channel_set {int max_channels; int /*<<< orphan*/ * private_data; struct snd_midi_channel* channels; } ;
...
#define  SNDRV_SEQ_EVENT_TIMESIGN 128 
 int /*<<< orphan*/  do_control (struct snd_midi_op*,int /*<<< orphan*/ *,struct snd_midi_channel_set*,struct snd_midi_channel*,int,int) ; 
 int /*<<< orphan*/  note_off (struct snd_midi_op*,int /*<<< orphan*/ *,struct snd_midi_channel*,size_t,scalar_t__) ; 
 int /*<<< orphan*/  nrpn (struct snd_midi_op*,int /*<<< orphan*/ *,struct snd_midi_channel*,struct snd_midi_channel_set*) ; 
 int /*<<< orphan*/  pr_debug (char*,...) ; 
 int /*<<< orphan*/  rpn (struct snd_midi_op*,int /*<<< orphan*/ *,struct snd_midi_channel*,struct snd_midi_channel_set*) ; 
 ...
 int /*<<< orphan*/  stub1 (int /*<<< orphan*/ *,size_t,int /*<<< orphan*/ ,struct snd_midi_channel*) ; 
 int /*<<< orphan*/  stub2 (int /*<<< orphan*/ *,size_t,scalar_t__,struct snd_midi_channel*) ; 
 int /*<<< orphan*/  stub3 (int /*<<< orphan*/ *,size_t,scalar_t__,struct snd_midi_channel*) ; 
 int /*<<< orphan*/  stub4 (int /*<<< orphan*/ *,int /*<<< orphan*/ ,struct snd_midi_channel*) ; 
 int /*<<< orphan*/  stub5 (int /*<<< orphan*/ *,int /*<<< orphan*/ ,struct snd_midi_channel*) ; 
 int /*<<< orphan*/  sysex (struct snd_midi_op*,int /*<<< orphan*/ *,unsigned char*,int,struct snd_midi_channel_set*) ; 
