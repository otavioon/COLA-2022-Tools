...
struct TYPE_10__ {size_t sock; int incomingSequence; int dropped; int fragmentSequence; int fragmentLength; int /*<<< orphan*/ * fragmentBuffer; int /*<<< orphan*/  remoteAddress; int /*<<< orphan*/  challenge; } ;
typedef  TYPE_1__ netchan_t ;
struct TYPE_11__ {int cursize; int readcount; int maxsize; int bit; int /*<<< orphan*/ * data; } ;
