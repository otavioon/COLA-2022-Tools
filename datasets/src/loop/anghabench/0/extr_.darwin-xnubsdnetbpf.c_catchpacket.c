...
struct bpf_d {int bd_flags; int bd_bufsize; int bd_slen; scalar_t__ bd_hbuf_read; scalar_t__ bd_headdrop; scalar_t__ bd_state; int bd_scnt; int /*<<< orphan*/ * bd_sbuf; scalar_t__ bd_immediate; int /*<<< orphan*/ * bd_hbuf; int /*<<< orphan*/ * bd_fbuf; scalar_t__ bd_hcnt; scalar_t__ bd_dcount; TYPE_1__* bd_bif; } ;
