...
/* Variables and functions */
 ...
 int /*<<< orphan*/ * TUN_METADATA_OPTS (struct sw_flow_key const*,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  WARN_ON_ONCE (int) ; 
 scalar_t__ eth_p_mpls (scalar_t__) ; 
 scalar_t__ eth_type_vlan (scalar_t__) ; 
 int /*<<< orphan*/  ether_addr_copy (int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 scalar_t__ htons (scalar_t__) ; 
 scalar_t__ ip_tun_to_nlattr (struct sk_buff*,TYPE_13__*,int /*<<< orphan*/  const*,int /*<<< orphan*/ ,scalar_t__) ; 
