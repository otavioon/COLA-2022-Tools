...
struct TYPE_22__ {int filter_size; int** filter; int pfn; int /*<<< orphan*/  (* yuv2packedX ) (TYPE_5__*,int*,int /*<<< orphan*/  const**,int,int*,int /*<<< orphan*/  const**,int /*<<< orphan*/  const**,int,int /*<<< orphan*/  const**,int /*<<< orphan*/ *,int,int) ;int /*<<< orphan*/ * filter_pos; } ;
