...
struct TYPE_29__ {struct ct_fdmiv2_port_attr* port_name; TYPE_3__ attrs; } ;
struct TYPE_22__ {TYPE_9__ rpa; TYPE_4__ rpa2; } ;
struct ct_sns_req {TYPE_10__ req; } ;
struct TYPE_33__ {int* fc4_types; int max_frame_size; char* host_name; char* port_sym_name; int* port_fc4_type; void* port_id; void* num_ports; void* port_state; struct ct_fdmiv2_port_attr* fabric_name; void* port_supported_cos; void* port_type; struct ct_fdmiv2_port_attr* port_name; struct ct_fdmiv2_port_attr* node_name; int /*<<< orphan*/  os_dev_name; void* cur_speed; void* sup_speed; } ;
...
#define  PORT_SPEED_8GB 128 
 ...
 int /*<<< orphan*/  memcpy (struct ct_fdmiv2_port_attr*,int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  ql_dbg (scalar_t__,TYPE_12__*,int,char*,...) ; 
 scalar_t__ ql_dbg_buffer ; 
 scalar_t__ ql_dbg_disc ; 
 int /*<<< orphan*/  ql_dump_buffer (scalar_t__,TYPE_12__*,int,struct ct_fdmiv2_port_attr*,int) ; 
 ...
 int /*<<< orphan*/  wwn_to_u64 (struct ct_fdmiv2_port_attr*) ; 
