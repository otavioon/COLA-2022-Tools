...
struct htc_packet {int act_len; int /*<<< orphan*/ * buf; int /*<<< orphan*/ * completion; } ;
...
struct htc_conn_service_resp {scalar_t__ status; int eid; int /*<<< orphan*/  max_msg_sz; int /*<<< orphan*/  svc_id; int /*<<< orphan*/  msg_id; } ;
