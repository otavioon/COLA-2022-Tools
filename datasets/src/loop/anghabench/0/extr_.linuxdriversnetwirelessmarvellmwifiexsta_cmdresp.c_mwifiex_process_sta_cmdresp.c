...
struct TYPE_6__ {int wait_q_enabled; int /*<<< orphan*/ * data_buf; } ;
...
#define  HostCmd_CMD_WMM_GET_STATUS 128 
 ...
 int mwifiex_ret_802_11_snmp_mib (struct mwifiex_private*,struct host_cmd_ds_command*,int /*<<< orphan*/ *) ; 
 ...
 int mwifiex_ret_enh_power_mode (struct mwifiex_private*,struct host_cmd_ds_command*,int /*<<< orphan*/ *) ; 
 int mwifiex_ret_get_chan_info (struct mwifiex_private*,struct host_cmd_ds_command*,int /*<<< orphan*/ *) ; 
 int mwifiex_ret_get_hw_spec (struct mwifiex_private*,struct host_cmd_ds_command*) ; 
 int mwifiex_ret_get_log (struct mwifiex_private*,struct host_cmd_ds_command*,int /*<<< orphan*/ *) ; 
 ...
 int mwifiex_ret_mem_access (struct mwifiex_private*,struct host_cmd_ds_command*,int /*<<< orphan*/ *) ; 
 int mwifiex_ret_p2p_mode_cfg (struct mwifiex_private*,struct host_cmd_ds_command*,int /*<<< orphan*/ *) ; 
 int mwifiex_ret_pkt_aggr_ctrl (struct mwifiex_private*,struct host_cmd_ds_command*) ; 
 int mwifiex_ret_reg_access (int,struct host_cmd_ds_command*,int /*<<< orphan*/ *) ; 
 int mwifiex_ret_remain_on_chan (struct mwifiex_private*,struct host_cmd_ds_command*,int /*<<< orphan*/ *) ; 
 ...
 int mwifiex_ret_robust_coex (struct mwifiex_private*,struct host_cmd_ds_command*,int /*<<< orphan*/ *) ; 
 ...
 int mwifiex_ret_ver_ext (struct mwifiex_private*,struct host_cmd_ds_command*,int /*<<< orphan*/ *) ; 
 int mwifiex_ret_wakeup_reason (struct mwifiex_private*,struct host_cmd_ds_command*,int /*<<< orphan*/ *) ; 
