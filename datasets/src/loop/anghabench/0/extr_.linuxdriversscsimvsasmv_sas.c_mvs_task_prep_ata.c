...
struct mvs_slot_info {size_t tx; int* buf; size_t buf_dma; int* response; } ;
...
struct TYPE_8__ {size_t (* prd_count ) () ;size_t (* prd_size ) () ;int /*<<< orphan*/  (* dma_fix ) (struct mvs_info*,size_t,int /*<<< orphan*/ ,size_t,int*) ;int /*<<< orphan*/  (* make_prd ) (int /*<<< orphan*/ ,size_t,int*) ;} ;
...
/* Variables and functions */
 ...
 size_t stub2 () ; 
 size_t stub3 () ; 
 int /*<<< orphan*/  stub4 (int /*<<< orphan*/ ,size_t,int*) ; 
 int /*<<< orphan*/  stub5 (struct mvs_info*,size_t,int /*<<< orphan*/ ,size_t,int*) ; 
