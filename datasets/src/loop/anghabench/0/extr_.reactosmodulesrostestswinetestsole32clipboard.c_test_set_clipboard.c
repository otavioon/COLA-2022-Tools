...
/* Variables and functions */
 ...
 int /*<<< orphan*/ * DataObjectImpl_CreateComplex (int /*<<< orphan*/ **) ; 
 int /*<<< orphan*/ * DataObjectImpl_CreateText (char*,int /*<<< orphan*/ **) ; 
 scalar_t__ FAILED (int /*<<< orphan*/ *) ; 
 int GMEM_DDESHARE ; 
 int GMEM_MOVEABLE ; 
 int GMEM_ZEROINIT ; 
 int /*<<< orphan*/ * GetClipboardData (void*) ; 
 int /*<<< orphan*/ * GlobalAlloc (int,int) ; 
 int /*<<< orphan*/ * GlobalLock (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  GlobalUnlock (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/ * IDataObject_Release (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/ * OleFlushClipboard () ; 
 int /*<<< orphan*/ * OleInitialize (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/ * OleIsCurrentClipboard (int /*<<< orphan*/ *) ; 
 ...
 int /*<<< orphan*/ * S_FALSE ; 
 int /*<<< orphan*/ * S_OK ; 
 int /*<<< orphan*/ * SetClipboardData (void*,int /*<<< orphan*/ *) ; 
 void* cf_another ; 
 void* cf_global ; 
 void* cf_onemore ; 
 void* cf_storage ; 
