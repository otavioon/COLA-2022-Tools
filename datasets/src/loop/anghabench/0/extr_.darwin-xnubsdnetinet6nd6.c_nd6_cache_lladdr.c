...
struct rtentry {int rt_flags; TYPE_1__* rt_gateway; int /*<<< orphan*/ * rt_llinfo; } ;
struct route_event {int dummy; } ;
struct radix_node_head {int /*<<< orphan*/  (* rnh_walktree ) (struct radix_node_head*,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ;} ;
...
#define  ND_ROUTER_SOLICIT 128 
 ...
 int /*<<< orphan*/  stub1 (struct radix_node_head*,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
