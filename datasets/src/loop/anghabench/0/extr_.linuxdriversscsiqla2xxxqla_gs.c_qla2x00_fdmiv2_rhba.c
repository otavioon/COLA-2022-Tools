...
struct TYPE_25__ {struct ct_fdmiv2_hba_attr* hba_identifier; TYPE_2__ attrs; struct ct_fdmiv2_hba_attr* port_name; void* entry_count; } ;
struct TYPE_26__ {TYPE_5__ rhba2; } ;
struct ct_sns_req {TYPE_6__ req; } ;
struct TYPE_24__ {char* manufacturer; char* serial_num; char* model; char* model_desc; char* hw_version; char* driver_version; char* orom_version; char* fw_version; char* os_version; int max_ct_len; char* sym_name; char* bios_name; char* vendor_identifier; struct ct_fdmiv2_hba_attr* fabric_name; int /*<<< orphan*/  num_ports; int /*<<< orphan*/  vendor_id; struct ct_fdmiv2_hba_attr* node_name; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  memcpy (struct ct_fdmiv2_hba_attr*,int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  ql_dbg (scalar_t__,TYPE_8__*,int,char*,...) ; 
 scalar_t__ ql_dbg_buffer ; 
 scalar_t__ ql_dbg_disc ; 
 int /*<<< orphan*/  ql_dump_buffer (scalar_t__,TYPE_8__*,int,struct ct_fdmiv2_hba_attr*,int) ; 
 ...
 int /*<<< orphan*/  wwn_to_u64 (struct ct_fdmiv2_hba_attr*) ; 
