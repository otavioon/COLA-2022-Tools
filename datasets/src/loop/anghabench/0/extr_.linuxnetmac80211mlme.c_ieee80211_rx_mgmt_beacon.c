...
struct TYPE_20__ {int driver_flags; struct ieee80211_bss_conf bss_conf; scalar_t__ p2p; int /*<<< orphan*/  chanctx_conf; } ;
struct ieee80211_if_managed {int have_beacon; int flags; scalar_t__ p2p_noa_index; int beacon_crc_valid; scalar_t__ beacon_crc; scalar_t__ csa_waiting_bcn; scalar_t__ powersave; int /*<<< orphan*/  aid; TYPE_4__* associated; TYPE_3__* assoc_data; scalar_t__ dtim_period; } ;
struct TYPE_17__ {struct ieee80211_if_managed mgd; } ;
struct ieee80211_sub_if_data {TYPE_9__ vif; TYPE_6__ u; struct ieee80211_local* local; } ;
...
struct TYPE_18__ {int /*<<< orphan*/  capab_info; int /*<<< orphan*/  timestamp; int /*<<< orphan*/ * variable; int /*<<< orphan*/  beacon_int; } ;
struct TYPE_19__ {TYPE_7__ beacon; } ;
struct ieee80211_mgmt {TYPE_8__ u; int /*<<< orphan*/  bssid; } ;
struct TYPE_16__ {scalar_t__ dynamic_ps_timeout; int flags; } ;
struct TYPE_11__ {TYPE_5__ conf; } ;
...
struct TYPE_12__ {struct ieee80211_channel* chan; } ;
struct ieee80211_chanctx_conf {TYPE_1__ def; } ;
typedef  int /*<<< orphan*/  noa ;
typedef  int /*<<< orphan*/  deauth_buf ;
struct TYPE_15__ {int /*<<< orphan*/ * bssid; } ;
struct TYPE_14__ {int need_beacon; int timeout_started; int /*<<< orphan*/  timeout; TYPE_2__* bss; } ;
...
/* Variables and functions */
 ...
 int cfg80211_get_p2p_attr (int /*<<< orphan*/ *,size_t,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int) ; 
 ...
 scalar_t__ ieee802_11_parse_elems_crc (int /*<<< orphan*/ *,size_t,int,struct ieee802_11_elems*,int /*<<< orphan*/ ,scalar_t__) ; 
 int /*<<< orphan*/  jiffies ; 
