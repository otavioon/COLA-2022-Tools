...
struct AdapterControlBlock {int adapter_type; int roundup_ccbsize; int completionQ_entry; int /*<<< orphan*/  doneq_index; int /*<<< orphan*/ * pCompletionQ; int /*<<< orphan*/ * dma_coherent2; void* dma_coherent_handle2; TYPE_1__* host; struct MessageUnit_D* pmuD; struct pci_dev* pdev; struct MessageUnit_B* pmuB; } ;
...
#define  ACB_ADAPTER_TYPE_E 128 
 ...
 int /*<<< orphan*/ * dma_zalloc_coherent (int /*<<< orphan*/ *,int,void**,int /*<<< orphan*/ ) ; 
