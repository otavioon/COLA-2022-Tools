...
#define  ZSTDds_skipFrame 132 
 ...
 int /*<<< orphan*/  ZSTDv07_checkContinuity (TYPE_3__*,int /*<<< orphan*/ *) ; 
 size_t ZSTDv07_copyRawBlock (int /*<<< orphan*/ *,size_t,int /*<<< orphan*/  const*,size_t) ; 
 size_t ZSTDv07_decodeFrameHeader (TYPE_3__*,size_t,size_t) ; 
 size_t ZSTDv07_decompressBlock_internal (TYPE_3__*,int /*<<< orphan*/ *,size_t,int /*<<< orphan*/  const*,size_t) ; 
 size_t ZSTDv07_frameHeaderSize (int /*<<< orphan*/  const*,size_t) ; 
 size_t ZSTDv07_frameHeaderSize_min ; 
 size_t ZSTDv07_getcBlockSize (int /*<<< orphan*/  const*,void*,TYPE_2__*) ; 
