...
struct TYPE_2__ {int /*<<< orphan*/ * (* get ) (struct tcf_proto*,scalar_t__) ;int /*<<< orphan*/  kind; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/ * stub1 (struct tcf_proto*,scalar_t__) ; 
 ...
 int tfilter_del_notify (struct net*,struct sk_buff*,struct nlmsghdr*,struct tcf_proto*,struct tcf_proto*,struct Qdisc*,scalar_t__,int /*<<< orphan*/ *,int,int*,struct netlink_ext_ack*) ; 
