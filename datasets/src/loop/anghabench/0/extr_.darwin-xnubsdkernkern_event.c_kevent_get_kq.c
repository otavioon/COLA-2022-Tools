...
struct kqworkloop {int kqwl_dynamicid; int /*<<< orphan*/  kqwl_params; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  kqueue_hash_insert (struct proc*,int,struct kqueue*) ; 
 struct kqueue* kqueue_hash_lookup (struct proc*,int) ; 
