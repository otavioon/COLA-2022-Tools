...
/* Variables and functions */
 ...
 int VFT_APP ; 
 int VOS__WINDOWS32 ; 
 int /*<<< orphan*/  expect_tag_dword (int /*<<< orphan*/ ,int,int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  expect_tag_empty (int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  expect_tag_qword (int /*<<< orphan*/ ,int,int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  expect_tag_skip (int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  expect_tag_skip_range (int /*<<< orphan*/ ,int,int) ; 
 int /*<<< orphan*/  expect_tag_str (int /*<<< orphan*/ ,int,int /*<<< orphan*/ ,char const*) ; 
 int /*<<< orphan*/  ok (int,char*,...) ; 
 int /*<<< orphan*/  pSdbFreeFileAttributes (int /*<<< orphan*/ ) ; 
 scalar_t__ pSdbGetFileAttributes (char const*,int /*<<< orphan*/ *,int*) ; 
