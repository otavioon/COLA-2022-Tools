...
/* Type definitions */
typedef  int int64_t ;
struct TYPE_8__ {scalar_t__ codec_id; scalar_t__ entropy; int /*<<< orphan*/  session; scalar_t__ realtime; int /*<<< orphan*/  has_b_frames; int /*<<< orphan*/ * color_primaries; int /*<<< orphan*/ * ycbcr_matrix; int /*<<< orphan*/ * transfer_function; scalar_t__ frames_after; scalar_t__ frames_before; int /*<<< orphan*/  allow_sw; } ;
typedef  TYPE_1__ VTEncContext ;
typedef  int /*<<< orphan*/  VTCompressionSessionRef ;
struct TYPE_11__ {int /*<<< orphan*/  kVTCompressionPropertyKey_RealTime; int /*<<< orphan*/  kVTCompressionPropertyKey_H264EntropyMode; int /*<<< orphan*/ * kVTH264EntropyMode_CAVLC; int /*<<< orphan*/ * kVTH264EntropyMode_CABAC; } ;
...
/* Variables and functions */
 ...
 int VTSessionSetProperty (int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ *) ; 
 scalar_t__ VT_CABAC ; 
