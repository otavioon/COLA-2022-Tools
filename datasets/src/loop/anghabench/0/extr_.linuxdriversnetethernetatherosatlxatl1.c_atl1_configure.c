...
/* Type definitions */
typedef  int u32 ;
struct atl1_hw {int* mac_addr; int ipgt; int min_ifg; int ipgr1; int ipgr2; int lcol; int max_retry; int jam_ipg; int max_frame_size; int rx_jumbo_th; int rx_jumbo_lkah; int rrd_ret_timer; int dev_rev; int tpd_burst; int txf_burst; int tpd_fetch_th; int tx_jumbo_task_th; int tpd_fetch_gap; int rfd_burst; int rrd_burst; int rfd_fetch_gap; int dmar_block; int dmaw_block; int dma_ord; scalar_t__ rcb_value; int cmb_tpd; int cmb_rrd; int cmb_rx_timer; int cmb_tx_timer; int smb_timer; scalar_t__ hw_addr; } ;
