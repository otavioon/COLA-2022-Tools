...
/* Type definitions */
struct TYPE_9__ {int init; int num; int shutdown; int /*<<< orphan*/  flags; int /*<<< orphan*/ * ptr; } ;
...
#define  BIO_C_SET_NBIO 128 
 ...
 long BIO_parse_hostserv (int /*<<< orphan*/ *,char**,char**,int /*<<< orphan*/ ) ; 
 char* BUF_strdup (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  OPENSSL_free (char*) ; 
 int /*<<< orphan*/  acpt_close_socket (TYPE_2__*) ; 
 int acpt_state (TYPE_2__*,TYPE_1__*) ; 
