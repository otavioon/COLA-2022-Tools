...
struct TYPE_34__ {size_t outBufLimit; int processed; TYPE_13__ vt; scalar_t__* outBuf; int /*<<< orphan*/ * realStream; } ;
struct TYPE_33__ {size_t unpackSize; int packSize; TYPE_3__* filters; } ;
struct TYPE_32__ {size_t unpackSize; int totalSize; size_t headerSize; } ;
...
struct TYPE_28__ {int checkId; size_t blockSize; int /*<<< orphan*/  lzma2Props; TYPE_2__ filterProps; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  SeqCheckInStream_Init (TYPE_7__*,int) ; 
 ...
 unsigned int XZ_GET_PAD_SIZE (int) ; 
