...
struct TYPE_6__ {int nin; int nout; scalar_t__ (* legacy_inner_loop_selector ) (TYPE_1__*,int /*<<< orphan*/ **,int /*<<< orphan*/ *,int /*<<< orphan*/ **,int*) ;} ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/ * PyArray_NewFromDescr (int /*<<< orphan*/ *,int /*<<< orphan*/ *,scalar_t__,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/ ,int /*<<< orphan*/ *) ; 
 ...
 scalar_t__ _does_loop_use_arrays (int /*<<< orphan*/ *) ; 
 scalar_t__ iterator_loop (TYPE_1__*,int /*<<< orphan*/ **,int /*<<< orphan*/ **,scalar_t__,int,int /*<<< orphan*/ **,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ; 
 scalar_t__ prepare_ufunc_output (TYPE_1__*,int /*<<< orphan*/ **,int /*<<< orphan*/ *,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 scalar_t__ stub1 (TYPE_1__*,int /*<<< orphan*/ **,int /*<<< orphan*/ *,int /*<<< orphan*/ **,int*) ; 
 int /*<<< orphan*/  trivial_three_operand_loop (int /*<<< orphan*/ **,int /*<<< orphan*/ ,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  trivial_two_operand_loop (int /*<<< orphan*/ **,int /*<<< orphan*/ ,int /*<<< orphan*/ *) ; 
