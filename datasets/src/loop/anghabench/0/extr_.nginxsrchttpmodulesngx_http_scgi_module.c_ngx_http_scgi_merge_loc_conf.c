...
struct TYPE_15__ {TYPE_1__ hash; } ;
struct TYPE_16__ {int num; size_t size; } ;
struct TYPE_21__ {scalar_t__ store; scalar_t__ buffering; scalar_t__ request_buffering; scalar_t__ ignore_client_abort; scalar_t__ force_ranges; scalar_t__ socket_keepalive; size_t send_lowat; size_t buffer_size; size_t limit_rate; size_t busy_buffers_size_conf; int busy_buffers_size; size_t temp_file_write_size_conf; int temp_file_write_size; size_t max_temp_file_size_conf; int max_temp_file_size; int ignore_headers; int next_upstream; scalar_t__ pass_request_headers; scalar_t__ pass_request_body; scalar_t__ intercept_errors; int /*<<< orphan*/ * upstream; int /*<<< orphan*/  temp_path; TYPE_13__ bufs; int /*<<< orphan*/  next_upstream_timeout; int /*<<< orphan*/  read_timeout; int /*<<< orphan*/  send_timeout; int /*<<< orphan*/  connect_timeout; int /*<<< orphan*/  local; int /*<<< orphan*/  next_upstream_tries; int /*<<< orphan*/  store_access; int /*<<< orphan*/  store_values; int /*<<< orphan*/  store_lengths; } ;
struct TYPE_18__ {TYPE_11__ params; int /*<<< orphan*/ * params_source; int /*<<< orphan*/ * scgi_lengths; TYPE_5__ upstream; int /*<<< orphan*/  scgi_values; } ;
typedef  TYPE_2__ ngx_http_scgi_loc_conf_t ;
struct TYPE_19__ {int /*<<< orphan*/ * handler; scalar_t__ lmt_excpt; scalar_t__ noname; } ;
typedef  TYPE_3__ ngx_http_core_loc_conf_t ;
struct TYPE_20__ {int max_size; char* name; int /*<<< orphan*/  bucket_size; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  ngx_conf_merge_bufs_value (TYPE_13__,TYPE_13__,int,int) ; 
 ...
 scalar_t__ ngx_http_scgi_init_params (int /*<<< orphan*/ *,TYPE_2__*,TYPE_11__*,int /*<<< orphan*/ *) ; 
