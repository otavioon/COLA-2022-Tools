...
struct sli3_bg_fields {int bghm; int bgstat; } ;
...
#define  SCSI_PROT_WRITE_STRIP 128 
 ...
 scalar_t__ lpfc_bgs_get_apptag_err (int) ; 
 scalar_t__ lpfc_bgs_get_guard_err (int) ; 
 scalar_t__ lpfc_bgs_get_hi_water_mark_present (int) ; 
 scalar_t__ lpfc_bgs_get_invalid_prof (int) ; 
 scalar_t__ lpfc_bgs_get_reftag_err (int) ; 
 scalar_t__ lpfc_bgs_get_uninit_dif_block (int) ; 
