...
/* Variables and functions */
 ...
 int ext4_ext_dirty (int /*<<< orphan*/ *,int /*<<< orphan*/ *,struct inode*,struct ext4_ext_path*) ; 
 int ext4_ext_get_access (int /*<<< orphan*/ *,int /*<<< orphan*/ *,struct inode*,struct ext4_ext_path*) ; 
 unsigned int ext4_ext_get_actual_len (struct ext4_extent*) ; 
 int ext4_ext_insert_extent (int /*<<< orphan*/ *,int /*<<< orphan*/ *,struct inode*,struct ext4_ext_path**,struct ext4_extent*,int) ; 
 ...
 int /*<<< orphan*/  ext4_ext_try_to_merge (int /*<<< orphan*/ *,int /*<<< orphan*/ *,struct inode*,struct ext4_ext_path*,struct ext4_extent*) ; 
