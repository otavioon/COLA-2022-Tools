...
typedef  size_t u32 ;
typedef  int u16 ;
struct TYPE_13__ {int /*<<< orphan*/ * dmac; } ;
...
struct hns_roce_dev {int loop_idc; int /*<<< orphan*/ ** dev_addr; TYPE_6__ caps; TYPE_3__ qp_table; TYPE_1__ mr_table; struct device* dev; } ;
