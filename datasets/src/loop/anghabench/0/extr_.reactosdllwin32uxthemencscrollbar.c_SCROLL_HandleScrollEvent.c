...
struct TYPE_36__ {int SCROLL_trackHitTest; int SCROLL_TrackingWin; int SCROLL_TrackingPos; int SCROLL_TrackingVal; int /*<<< orphan*/  SCROLL_MovingThumb; scalar_t__ SCROLL_TrackingBar; scalar_t__ SCROLL_trackVertical; } ;
...
/* Variables and functions */
 ...
 int GetFocus () ; 
 int GetParent (int) ; 
 int /*<<< orphan*/  GetScrollBarInfo (int,int /*<<< orphan*/ ,TYPE_4__*) ; 
 int /*<<< orphan*/  GetScrollInfo (int,scalar_t__,TYPE_3__*) ; 
 int /*<<< orphan*/  HideCaret (int) ; 
 int /*<<< orphan*/  KillSystemTimer (int,int /*<<< orphan*/ ) ; 
...
#define  SCROLL_BOTTOM_RECT 136 
 ...
 int SCROLL_HitTest (int,TYPE_4__*,scalar_t__,TYPE_6__,int /*<<< orphan*/ ) ; 
 scalar_t__ SCROLL_IsVertical (int,scalar_t__) ; 
...
#define  SCROLL_TOP_RECT 132 
 ...
 int /*<<< orphan*/  SendMessageW (int,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  SetCapture (int) ; 
 int /*<<< orphan*/  SetSystemTimer (int,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  ShowCaret (int) ; 
 int /*<<< orphan*/  TRUE ; 
 int /*<<< orphan*/  ThemeCleanupDrawContext (TYPE_7__*) ; 
 int /*<<< orphan*/  ThemeInitDrawContext (TYPE_7__*,int,int /*<<< orphan*/ ) ; 
