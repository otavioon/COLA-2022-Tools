...
struct TYPE_6__ {int lport; int fport; int fcoe; int iport; int pfvf_vld; int ovlan_vld; int ivlan; int tos; int proto; int ethtype; int macidx; int matchtype; int frag; int /*<<< orphan*/  lip; int /*<<< orphan*/  fip; scalar_t__ encap_vld; } ;
