...
struct metapage {TYPE_1__ header; int /*<<< orphan*/  i_sb; int /*<<< orphan*/ * xad; int /*<<< orphan*/ * data; } ;
...
struct inode {TYPE_1__ header; int /*<<< orphan*/  i_sb; int /*<<< orphan*/ * xad; int /*<<< orphan*/ * data; } ;
