...
/* Type definitions */
struct f2fs_sb_info {int user_block_count; unsigned long gc_mode; int iostat_enable; TYPE_1__* gc_thread; int /*<<< orphan*/  stat_lock; int /*<<< orphan*/  reserved_blocks; int /*<<< orphan*/  current_reserved_blocks; int /*<<< orphan*/  sb_lock; } ;
struct TYPE_5__ {int /*<<< orphan*/  name; } ;
struct f2fs_attr {scalar_t__ struct_type; int offset; TYPE_2__ attr; } ;
typedef  size_t ssize_t ;
struct TYPE_6__ {int root_reserved_blocks; } ;
