...
struct TYPE_19__ {int playlen; TYPE_10__ path; } ;
typedef  TYPE_4__ ngx_rtmp_hls_cleanup_t ;
struct TYPE_20__ {int fraglen; int max_fraglen; int muxdelay; int sync; int playlen; scalar_t__ naming; scalar_t__ slicing; scalar_t__ type; int max_audio_delay; scalar_t__ frags_per_key; int winfrags; TYPE_10__ path; TYPE_10__ key_path; TYPE_13__* slot; scalar_t__ cleanup; scalar_t__ keys; scalar_t__ hls; TYPE_10__ key_url; scalar_t__ granularity; TYPE_10__ base_url; int /*<<< orphan*/  audio_buffer_size; scalar_t__ nested; scalar_t__ continuous; } ;
typedef  TYPE_5__ ngx_rtmp_hls_app_conf_t ;
struct TYPE_21__ {TYPE_2__* conf_file; int /*<<< orphan*/  pool; } ;
typedef  TYPE_6__ ngx_conf_t ;
struct TYPE_16__ {int /*<<< orphan*/  data; } ;
struct TYPE_18__ {TYPE_1__ name; } ;
struct TYPE_17__ {int /*<<< orphan*/  line; TYPE_3__ file; } ;
struct TYPE_15__ {int /*<<< orphan*/  line; int /*<<< orphan*/  conf_file; TYPE_4__* data; TYPE_10__ name; void* manager; } ;
