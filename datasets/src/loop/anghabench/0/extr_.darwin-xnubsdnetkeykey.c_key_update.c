...
struct sadb_msghdr {int* extlen; TYPE_2__* msg; int /*<<< orphan*/ ** ext; } ;
...
struct TYPE_10__ {scalar_t__ proto; scalar_t__ mode; TYPE_1__ src; } ;
struct TYPE_9__ {TYPE_4__ saidx; } ;
struct TYPE_8__ {scalar_t__ sadb_msg_satype; int /*<<< orphan*/  sadb_msg_pid; } ;
