...
struct unpacked {size_t depth; int /*<<< orphan*/ * data; int /*<<< orphan*/  index; TYPE_1__* object; } ;
struct TYPE_7__ {scalar_t__ type; size_t size; size_t delta_size; struct TYPE_7__* delta; int /*<<< orphan*/ * delta_data; int /*<<< orphan*/  id; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/ * git__realloc (int /*<<< orphan*/ *,size_t) ; 
 scalar_t__ git_delta_create_from_index (int /*<<< orphan*/ **,size_t*,int /*<<< orphan*/ ,int /*<<< orphan*/ *,size_t,size_t) ; 
 scalar_t__ git_delta_index_init (int /*<<< orphan*/ *,int /*<<< orphan*/ *,size_t) ; 
