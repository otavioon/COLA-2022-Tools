...
struct rtw_dig {scalar_t__ CurIGValue; scalar_t__ DIG_Dynamic_MIN_0; scalar_t__ rx_gain_range_max; int AntDiv_RSSI_max; int LargeFAHit; scalar_t__ ForbiddenIGI; int rx_gain_range_min; int Recover_cnt; scalar_t__ bMediaConnect_0; } ;
