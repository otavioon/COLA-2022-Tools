...
/* Variables and functions */
 ...
 int /*<<< orphan*/  HUF_buildCTable_wksp (int /*<<< orphan*/ *,unsigned int*,unsigned int,unsigned int,int /*<<< orphan*/ *,size_t) ; 
 size_t HUF_compressCTable_internal (int /*<<< orphan*/ * const,int /*<<< orphan*/ *,int /*<<< orphan*/ * const,int /*<<< orphan*/  const*,size_t,unsigned int,int /*<<< orphan*/ *) ; 
 ...
 int /*<<< orphan*/  HUF_writeCTable_wksp (int /*<<< orphan*/ *,size_t,int /*<<< orphan*/ *,unsigned int,unsigned int,int /*<<< orphan*/ *,size_t) ; 
 size_t const hSize ; 
 size_t largest ; 
