...
struct TYPE_9__ {int frameContentSize; int /*<<< orphan*/  checksumFlag; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  ZSTD_checkContinuity (TYPE_3__*,int /*<<< orphan*/ *) ; 
 size_t ZSTD_copyRawBlock (int /*<<< orphan*/ *,size_t,int /*<<< orphan*/  const*,size_t) ; 
 int /*<<< orphan*/  ZSTD_decodeFrameHeader (TYPE_3__*,size_t,size_t) ; 
 size_t ZSTD_decompressBlock_internal (TYPE_3__*,int /*<<< orphan*/ *,size_t,int /*<<< orphan*/  const*,size_t,int) ; 
 int /*<<< orphan*/  ZSTD_f_zstd1 ; 
 size_t ZSTD_frameHeaderSize_internal (int /*<<< orphan*/  const*,size_t,int /*<<< orphan*/ ) ; 
 size_t ZSTD_getcBlockSize (int /*<<< orphan*/  const*,void*,TYPE_2__*) ; 
 int /*<<< orphan*/  ZSTD_isError (size_t const) ; 
 size_t ZSTD_setRleBlock (int /*<<< orphan*/ *,size_t,int /*<<< orphan*/  const*,size_t,int /*<<< orphan*/ ) ; 
