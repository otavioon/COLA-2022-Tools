...
/* Variables and functions */
 int APPLY_HORIZ_QPEL_NO_ROUND_FILTER_8BYTE (int,int,int,int,int,int,int,int,int) ; 
 int APPLY_HORIZ_QPEL_NO_ROUND_FILTER_8BYTE_1ROW (int,int,int,int,int,int,int,int) ; 
 ...
 int __msa_insve_d (int /*<<< orphan*/ ,int,int /*<<< orphan*/ ) ; 
 int __msa_ldi_b (int) ; 
 int __msa_sldi_b (int /*<<< orphan*/ ,int /*<<< orphan*/ ,int) ; 
 int __msa_splati_d (int /*<<< orphan*/ ,int) ; 

__attribute__((used)) static void hv_mc_qpel_no_rnd_aver_h_src1_8x8_msa(const uint8_t *src,
                                                  int32_t src_stride,
                                                  uint8_t *dst,
                                                  int32_t dst_stride)
{
