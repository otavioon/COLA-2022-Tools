...
struct TYPE_6__ {int type; scalar_t__ callNumber; int seq; int flags; scalar_t__ serviceId; scalar_t__ securityIndex; int serial; unsigned int cid; } ;
...
struct rxrpc_connection {scalar_t__ security_ix; scalar_t__ service_id; int hi_serial; struct rxrpc_channel* channels; int /*<<< orphan*/  debug_id; TYPE_2__ params; int /*<<< orphan*/  flags; } ;
...
struct rxrpc_call {scalar_t__ service_id; int rx_serial; int /*<<< orphan*/  user_mutex; int /*<<< orphan*/  usage; int /*<<< orphan*/  flags; } ;
...
#define  RXRPC_PACKET_TYPE_VERSION 128 
 ...
 int /*<<< orphan*/  trace_rxrpc_rx_data (int /*<<< orphan*/ ,int,int,int,int /*<<< orphan*/ ) ; 
