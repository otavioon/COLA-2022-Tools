...
/* Type definitions */
struct TYPE_12__ {int selected_item; int focus_item; int style; int self; int page_size; int nb_items; int width; int column_width; int anchor_item; TYPE_2__* lphc; TYPE_1__* items; int /*<<< orphan*/  owner; } ;
