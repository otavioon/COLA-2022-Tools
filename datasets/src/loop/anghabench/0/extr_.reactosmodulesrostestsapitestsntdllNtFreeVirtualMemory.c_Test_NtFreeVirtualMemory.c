...
/* Variables and functions */
 ...
 int /*<<< orphan*/  NtAllocateVirtualMemory (int /*<<< orphan*/ ,scalar_t__*,int /*<<< orphan*/ ,int*,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  NtCurrentProcess () ; 
 int /*<<< orphan*/  NtFreeVirtualMemory (int /*<<< orphan*/ ,scalar_t__*,int*,int /*<<< orphan*/ ) ; 
