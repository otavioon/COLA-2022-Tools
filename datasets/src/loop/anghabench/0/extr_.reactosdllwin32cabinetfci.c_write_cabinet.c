...
struct TYPE_18__ {int folders_size; int placed_files_size; int folders_data_size; int cFolders; int cFiles; int (* open ) (char*,int,int,int*,int /*<<< orphan*/ ) ;int (* write ) (int,TYPE_4__*,int,int*,int /*<<< orphan*/ ) ;scalar_t__ (* seek ) (int,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int*,int /*<<< orphan*/ ) ;int /*<<< orphan*/  pv; int /*<<< orphan*/  (* delete ) (char*,int*,int /*<<< orphan*/ ) ;int /*<<< orphan*/  (* close ) (int,int*,int /*<<< orphan*/ ) ;int /*<<< orphan*/  estimatedCabinetSize; TYPE_2__ ccab; TYPE_1__* pccab; int /*<<< orphan*/  szPrevDisk; int /*<<< orphan*/  szPrevCab; scalar_t__ fNextCab; scalar_t__ fPrevCab; int /*<<< orphan*/ * data_out; } ;
