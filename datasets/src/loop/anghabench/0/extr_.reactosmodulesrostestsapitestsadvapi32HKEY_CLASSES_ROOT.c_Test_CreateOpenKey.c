...
/* Variables and functions */
 scalar_t__ DeleteSubKey (int /*<<< orphan*/ ,char*,char*) ; 
 ...
 int /*<<< orphan*/  ok_hdl (int /*<<< orphan*/ ,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  ok_hex (scalar_t__,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  ok_key_deleted (int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  ok_key_name (int /*<<< orphan*/ ,int /*<<< orphan*/ *,char*) ; 
 int /*<<< orphan*/  ok_key_not_deleted (int /*<<< orphan*/ ) ; 
