...
struct TYPE_9__ {size_t FSMC_Bank; int FSMC_DataAddressMux; int FSMC_MemoryType; int FSMC_MemoryDataWidth; int FSMC_BurstAccessMode; int FSMC_AsynchronousWait; int FSMC_WaitSignalPolarity; int FSMC_WrapMode; int FSMC_WaitSignalActive; int FSMC_WriteOperation; int FSMC_WaitSignal; int FSMC_ExtendedMode; int FSMC_WriteBurst; TYPE_2__* FSMC_WriteTimingStruct; TYPE_1__* FSMC_ReadWriteTimingStruct; } ;
struct TYPE_8__ {int FSMC_AddressSetupTime; int FSMC_AddressHoldTime; int FSMC_DataSetupTime; int FSMC_CLKDivision; int FSMC_DataLatency; int FSMC_AccessMode; } ;
struct TYPE_7__ {int FSMC_AddressSetupTime; int FSMC_AddressHoldTime; int FSMC_DataSetupTime; int FSMC_BusTurnAroundDuration; int FSMC_CLKDivision; int FSMC_DataLatency; int FSMC_AccessMode; } ;
