...
struct pp_hwmgr {int feature_mask; int workload_mask; int* workload_prority; size_t power_profile_mode; size_t default_power_profile_mode; scalar_t__ chip_id; scalar_t__ chip_family; scalar_t__ pp_table_version; TYPE_7__ platform_descriptor; scalar_t__ is_kicker; struct amdgpu_device* adev; int /*<<< orphan*/ * pptable; int /*<<< orphan*/ * backend; } ;
