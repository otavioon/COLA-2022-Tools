...
typedef  int u32 ;
typedef  int u16 ;
struct TYPE_32__ {int /*<<< orphan*/ * dmac; } ;
struct TYPE_26__ {TYPE_5__ roce; } ;
struct ib_qp_attr {int qp_access_flags; int pkey_index; int min_rnr_timer; int port_num; int max_dest_rd_atomic; int dest_qp_num; int path_mtu; int rq_psn; int sq_psn; int retry_cnt; int rnr_retry; int timeout; int max_rd_atomic; TYPE_14__ ah_attr; } ;
...
struct TYPE_22__ {int wqe_cnt; scalar_t__ tail; scalar_t__ head; } ;
struct TYPE_36__ {int wqe_cnt; int head; int offset; scalar_t__ tail; scalar_t__ db_reg_l; } ;
struct TYPE_27__ {int first_seg; } ;
struct TYPE_31__ {int /*<<< orphan*/  qp_type; } ;
struct hns_roce_qp {int qpn; int access_flags; int pkey_index; int port; int phy_port; int sl; int state; int resp_depth; scalar_t__ sq_next_wqe; TYPE_10__ sq; TYPE_9__ rq; TYPE_19__ mtt; int /*<<< orphan*/  sq_signal_bits; TYPE_4__ ibqp; } ;
...
struct hns_roce_dev {int loop_idc; TYPE_8__ iboe; TYPE_7__ priv_uar; scalar_t__ odb_offset; scalar_t__ reg_base; int /*<<< orphan*/ ** dev_addr; TYPE_3__ qp_table; TYPE_2__ mr_table; TYPE_1__* pdev; } ;
