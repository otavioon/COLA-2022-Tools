...
struct bna_tcb {scalar_t__ q_depth; scalar_t__ producer_index; scalar_t__* hw_consumer_index; scalar_t__ consumer_index; int /*<<< orphan*/  flags; int /*<<< orphan*/ * sw_q; int /*<<< orphan*/  i_dbell; struct bnad_tx_unmap* unmap_q; } ;
