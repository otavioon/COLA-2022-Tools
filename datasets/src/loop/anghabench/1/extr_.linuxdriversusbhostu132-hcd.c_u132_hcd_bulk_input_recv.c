...
/* Variables and functions */
 ...
 int usb_ftdi_elan_edset_input (TYPE_2__*,int /*<<< orphan*/ ,struct u132_endp*,struct urb*,size_t,int /*<<< orphan*/ ,int,void (*) (struct u132_endp*,struct urb*,size_t*,int,int,int,int,int,int,int,int,int)) ; 
