...
struct spi_device {size_t chip_select; int /*<<< orphan*/  dev; int /*<<< orphan*/  master; int /*<<< orphan*/ * controller_data; } ;
...
struct davinci_spi {int* bytes_per_word; int wcount; int rcount; int (* get_tx ) (struct davinci_spi*) ;int pbase; scalar_t__ base; int /*<<< orphan*/  done; int /*<<< orphan*/  dma_tx; int /*<<< orphan*/  dma_rx; int /*<<< orphan*/  rx; int /*<<< orphan*/  tx; struct davinci_spi_platform_data pdata; } ;
