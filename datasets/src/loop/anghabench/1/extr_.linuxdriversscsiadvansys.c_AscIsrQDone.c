...
struct TYPE_10__ {int target_ix; unsigned long srb_tag; } ;
...
/* Variables and functions */
 ...
 int ASC_QNO_TO_QADDR (scalar_t__) ; 
 int ASC_SCSIQ_B_FWD ; 
 int ASC_SCSIQ_B_STATUS ; 
 int ASC_SCSIQ_CDB_BEG ; 
 int ASC_TIX_TO_TARGET_ID (int) ; 
 scalar_t__ ASC_TIX_TO_TID (int) ; 
 int AscGetVarDoneQTail (int /*<<< orphan*/ ) ; 
 ...
 int /*<<< orphan*/  AscWriteLramByte (int /*<<< orphan*/ ,int,int) ; 
 scalar_t__ CC_HALT ; 
 ...
 int QS_READY ; 
 void* START_STOP ; 
 scalar_t__ _AscCopyLramScsiDoneQ (int /*<<< orphan*/ ,int,TYPE_3__*,int /*<<< orphan*/ ) ; 
