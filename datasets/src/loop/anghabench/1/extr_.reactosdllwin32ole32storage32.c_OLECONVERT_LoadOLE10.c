...
struct TYPE_18__ {scalar_t__ dwOleID; scalar_t__ dwTypeID; int dwOleTypeNameLength; int dwOleObjFileNameLength; int dwDataLength; int /*<<< orphan*/ * pData; int /*<<< orphan*/ * strUnknown; int /*<<< orphan*/  dwMetaFileHeight; int /*<<< orphan*/  dwMetaFileWidth; int /*<<< orphan*/ * pstrOleObjFileName; int /*<<< orphan*/ * strOleTypeName; } ;
struct TYPE_17__ {int (* Get ) (TYPE_3__*,int /*<<< orphan*/ *,int) ;} ;
...
/* Variables and functions */
 ...
 int stub10 (TYPE_3__*,int /*<<< orphan*/ *,int) ; 
 int stub11 (TYPE_3__*,int /*<<< orphan*/ *,int) ; 
 int stub2 (TYPE_3__*,int /*<<< orphan*/ *,int) ; 
 int stub3 (TYPE_3__*,int /*<<< orphan*/ *,int) ; 
 int stub4 (TYPE_3__*,int /*<<< orphan*/ *,int) ; 
 int stub5 (TYPE_3__*,int /*<<< orphan*/ *,int) ; 
 int stub6 (TYPE_3__*,int /*<<< orphan*/ *,int) ; 
 int stub7 (TYPE_3__*,int /*<<< orphan*/ *,int) ; 
 int stub8 (TYPE_3__*,int /*<<< orphan*/ *,int) ; 
 int stub9 (TYPE_3__*,int /*<<< orphan*/ *,int) ; 
