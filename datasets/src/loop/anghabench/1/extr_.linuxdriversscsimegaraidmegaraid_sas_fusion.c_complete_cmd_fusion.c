...
struct megasas_cmd_fusion {int* sense; size_t pd_r1_lb; size_t sync_cmd_idx; int /*<<< orphan*/  r1_alt_dev_handle; struct scsi_cmnd* scmd; int /*<<< orphan*/  done; int /*<<< orphan*/ * io_request; } ;
