...
#define  NL80211_BAND_5GHZ 128 
 ...
 int iwl_get_channel_for_reset_scan (struct iwl_priv*,struct ieee80211_vif*,int,int /*<<< orphan*/ ) ; 
 int iwl_get_channels_for_scan (struct iwl_priv*,struct ieee80211_vif*,int,int,int,int /*<<< orphan*/ ) ; 
