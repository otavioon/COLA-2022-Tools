...
struct TYPE_34__ {int read_waiting; int eof; scalar_t__ (* input_filter ) (int /*<<< orphan*/ ,size_t) ;int ft_type; int /*<<< orphan*/  read_timeout; scalar_t__ body_downstream; int /*<<< orphan*/  socket_errno; scalar_t__ raw_downstream; TYPE_10__ buffer; int /*<<< orphan*/  input_filter_ctx; TYPE_2__ peer; } ;
...
struct TYPE_36__ {int ready; scalar_t__ timer_set; scalar_t__ active; } ;
typedef  TYPE_8__ ngx_event_t ;
struct TYPE_37__ {scalar_t__ (* recv ) (TYPE_9__*,int,size_t) ;TYPE_8__* read; int /*<<< orphan*/  log; } ;
typedef  TYPE_9__ ngx_connection_t ;
typedef  TYPE_10__ ngx_buf_t ;
struct TYPE_32__ {int rest; } ;
struct TYPE_31__ {int /*<<< orphan*/  log; } ;
struct TYPE_29__ {size_t last; size_t pos; } ;
...
/* Variables and functions */
 ...
 void* ngx_copy (int,size_t,size_t) ; 
 ...
 int /*<<< orphan*/  ngx_http_lua_probe_req_socket_consume_preread (TYPE_5__*,size_t,size_t) ; 
 ...
 scalar_t__ stub2 (TYPE_9__*,int,size_t) ; 
