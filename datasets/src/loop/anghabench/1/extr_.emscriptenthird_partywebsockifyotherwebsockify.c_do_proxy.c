...
/* Type definitions */
struct TYPE_5__ {int sockfd; int* cout_buf; int /*<<< orphan*/  tout_buf; scalar_t__ tin_buf; scalar_t__ hybi; int /*<<< orphan*/  cin_buf; } ;
...
/* Variables and functions */
 ...
 unsigned int encode_hixie (int /*<<< orphan*/ ,scalar_t__,int*,scalar_t__) ; 
 unsigned int encode_hybi (int /*<<< orphan*/ ,scalar_t__,int*,scalar_t__,int) ; 
 int /*<<< orphan*/  errno ; 
 ...
 scalar_t__ ws_send (TYPE_1__*,int*,scalar_t__) ; 
