...
struct TYPE_11__ {scalar_t__ projection; double padding; int yaw; int pitch; int roll; } ;
...
/* Variables and functions */
 ...
 double AV_RL32 (int /*<<< orphan*/ *) ; 
 double AV_RL8 (int /*<<< orphan*/ *) ; 
 ...
 int /*<<< orphan*/  writer_print_integers (int /*<<< orphan*/ *,char*,int /*<<< orphan*/ *,int,char*,int,int,int) ; 
