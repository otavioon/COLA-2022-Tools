...
/* Type definitions */
typedef  int u32 ;
struct minstrel_rate_stats {int prob_ewma; int retry_count; int last_success; int last_attempts; int succ_hist; int att_hist; } ;
struct minstrel_ht_sta {int* supported; int* max_tp_rate; int max_prob_rate; int total_packets; int sample_packets; int avg_ampdu_len; TYPE_1__* groups; } ;
