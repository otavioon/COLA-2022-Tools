...
struct atl1e_rx_ring {scalar_t__ page_size; int /*<<< orphan*/ * rx_page_desc; } ;
struct atl1e_rx_page_desc {int rx_nxseq; size_t rx_using; } ;
struct atl1e_rx_page {scalar_t__* write_offset_addr; scalar_t__ read_offset; int /*<<< orphan*/ * addr; } ;
struct atl1e_recv_ret_status {int seq_num; int pkt_flag; int err_flag; scalar_t__ word1; int vtag; } ;
