...
/* Type definitions */
struct TYPE_35__ {int fflags; int bitstream_size; int key_frame; unsigned int output_size; int flags; int compression; long* size; TYPE_20__* prev_frame; scalar_t__ rgb; scalar_t__ dct; int /*<<< orphan*/  output; int /*<<< orphan*/  gbyte; int /*<<< orphan*/  gb; } ;
struct TYPE_34__ {scalar_t__ codec_tag; int width; int height; scalar_t__ coded_width; scalar_t__ coded_height; TYPE_4__* priv_data; } ;
struct TYPE_33__ {int key_frame; scalar_t__ width; scalar_t__ height; scalar_t__ crop_left; scalar_t__ crop_top; int /*<<< orphan*/  pict_type; } ;
struct TYPE_32__ {scalar_t__ width; scalar_t__ height; int /*<<< orphan*/ * data; } ;
struct TYPE_31__ {unsigned int size; int flags; int /*<<< orphan*/  data; } ;
