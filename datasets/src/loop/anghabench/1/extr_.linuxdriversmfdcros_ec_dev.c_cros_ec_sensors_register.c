...
/* Type definitions */
struct mfd_cell {int version; int outsize; int insize; scalar_t__ result; char* name; int sensor_num; int id; int pdata_size; struct mfd_cell* platform_data; int /*<<< orphan*/ * data; scalar_t__ command; } ;
...
struct cros_ec_sensor_platform {int version; int outsize; int insize; scalar_t__ result; char* name; int sensor_num; int id; int pdata_size; struct cros_ec_sensor_platform* platform_data; int /*<<< orphan*/ * data; scalar_t__ command; } ;
struct cros_ec_dev {int has_kb_wake_angle; int /*<<< orphan*/  dev; int /*<<< orphan*/  ec_dev; scalar_t__ cmd_offset; } ;
struct cros_ec_command {int version; int outsize; int insize; scalar_t__ result; char* name; int sensor_num; int id; int pdata_size; struct cros_ec_command* platform_data; int /*<<< orphan*/ * data; scalar_t__ command; } ;
