...
struct mvumi_res {unsigned int bus_addr; int /*<<< orphan*/ * virt_addr; } ;
struct mvumi_ob_data {int /*<<< orphan*/  list; } ;
struct TYPE_4__ {int size; int /*<<< orphan*/ * stack; } ;
struct mvumi_hba {int fw_flag; unsigned int ib_max_size; unsigned int max_io; int hba_capability; int ob_max_size; unsigned int ib_list_phys; unsigned int ib_frame_phys; unsigned int ib_shadow_phys; unsigned int ob_shadow_phys; unsigned int ob_list_phys; unsigned int max_target_id; int /*<<< orphan*/ * target_map; int /*<<< orphan*/ * tag_cmd; TYPE_2__ tag_pool; TYPE_1__* pdev; int /*<<< orphan*/  ob_data_list; int /*<<< orphan*/ * ob_list; int /*<<< orphan*/ * ob_shadow; int /*<<< orphan*/ * ib_shadow; int /*<<< orphan*/ * ib_frame; int /*<<< orphan*/ * ib_list; } ;
