...
struct TYPE_25__ {int PLength; int /*<<< orphan*/ * P; } ;
struct TYPE_24__ {size_t IndCh; size_t No; int RCurrent; size_t MInd; int complete; size_t Ind; size_t RLength; size_t RNum; int RNR; int ROffset; } ;
