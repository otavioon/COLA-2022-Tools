...
/* Variables and functions */
 ...
 int /*<<< orphan*/  DOTP_SB3_SH (int,int,int,int,int,int,int,int,int) ; 
 int /*<<< orphan*/  DPADD_SB2_SH (int,int,int,int,int,int) ; 
 int /*<<< orphan*/  HEVC_BIW_RND_CLIP2 (int,int,int,int,int,int,int,int,int) ; 
 int /*<<< orphan*/  ILVL_B2_SB (int,int,int,int,int,int) ; 
 int /*<<< orphan*/  ILVL_B4_SB (int,int,int,int,int,int,int,int,int,int,int,int) ; 
 int /*<<< orphan*/  ILVRL_H2_SW (int,int,int,int) ; 
 int /*<<< orphan*/  ILVR_B2_SB (int,int,int,int,int,int) ; 
 int /*<<< orphan*/  ILVR_B4_SB (int,int,int,int,int,int,int,int,int,int,int,int) ; 
 int /*<<< orphan*/  ILVR_D3_SB (int,int,int,int,int,int,int,int,int) ; 
 int /*<<< orphan*/  LD_SB2 (int /*<<< orphan*/ *,int,int,int) ; 
 ...
 int /*<<< orphan*/  XORI_B2_128_SB (int,int) ; 
