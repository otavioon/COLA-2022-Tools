...
struct TYPE_21__ {int /*<<< orphan*/  txok; int /*<<< orphan*/  txunder; int /*<<< orphan*/  txabort; int /*<<< orphan*/  brk; int /*<<< orphan*/  exithunt; } ;
struct TYPE_20__ {scalar_t__ mode; } ;
struct TYPE_22__ {int irq_occurred; int bh_requested; int /*<<< orphan*/  irq_level; int /*<<< orphan*/  lock; int /*<<< orphan*/  task; int /*<<< orphan*/  device_name; int /*<<< orphan*/  bh_running; scalar_t__ pending_bh; TYPE_3__ icount; scalar_t__ tx_aborting; TYPE_2__ params; TYPE_7__ port; int /*<<< orphan*/  event_wait_q; TYPE_1__* p_dev; } ;
struct TYPE_19__ {int /*<<< orphan*/  _locked; } ;
