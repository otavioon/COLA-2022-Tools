...
struct TYPE_22__ {int /*<<< orphan*/ * (* alloc ) (TYPE_1__*,int /*<<< orphan*/ *,size_t,size_t,int*,int*,int /*<<< orphan*/ ) ;} ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/ * extent_alloc_default_impl (int /*<<< orphan*/ *,TYPE_2__*,int /*<<< orphan*/ *,size_t,size_t,int*,int*) ; 
 ...
 int /*<<< orphan*/  extent_init (int /*<<< orphan*/ *,TYPE_2__*,int /*<<< orphan*/ *,size_t,int,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int,int,int) ; 
 ...
 scalar_t__ pages_purge_forced (int /*<<< orphan*/ *,size_t) ; 
 int /*<<< orphan*/ * stub1 (TYPE_1__*,int /*<<< orphan*/ *,size_t,size_t,int*,int*,int /*<<< orphan*/ ) ; 
