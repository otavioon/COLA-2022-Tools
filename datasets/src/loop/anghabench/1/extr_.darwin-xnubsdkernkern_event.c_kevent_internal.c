...
struct kqworkloop {int kqwl_dynamicid; struct kqrequest kqwl_request; } ;
...
/* Variables and functions */
 ...
 int get_bsdthread_info (int /*<<< orphan*/ ) ; 
 ...
 int kevent_get_kq (struct proc*,int,int /*<<< orphan*/ *,unsigned int,struct fileproc**,int*,struct kqueue**) ; 
 ...
 int /*<<< orphan*/  kevent_put_kq (struct proc*,int,struct fileproc*,struct kqueue*) ; 
