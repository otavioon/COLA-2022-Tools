...
/* Type definitions */
struct TYPE_16__ {scalar_t__ snd_una; scalar_t__ conv; int rmt_wnd; scalar_t__ current; int rx_rto; scalar_t__ rcv_nxt; scalar_t__ rcv_wnd; int cwnd; scalar_t__ mss; int ssthresh; scalar_t__ incr; int /*<<< orphan*/  probe; } ;
