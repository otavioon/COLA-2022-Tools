...
struct svc_export {int ex_flags; int ex_fsid; TYPE_9__ ex_path; int /*<<< orphan*/  ex_uuid; TYPE_2__ ex_fslocs; } ;
...
struct kstatfs {int f_ffree; int f_files; int f_namelen; int f_bavail; int f_bsize; int f_bfree; int f_blocks; } ;
struct TYPE_18__ {int tv_sec; int tv_nsec; } ;
struct TYPE_17__ {int tv_sec; int tv_nsec; } ;
struct TYPE_16__ {int tv_sec; int tv_nsec; } ;
struct kstat {int mode; int size; int ino; int nlink; int blocks; TYPE_7__ mtime; TYPE_6__ ctime; TYPE_5__ atime; int /*<<< orphan*/  rdev; int /*<<< orphan*/  gid; int /*<<< orphan*/  uid; int /*<<< orphan*/  dev; } ;
...
#define  FSIDSOURCE_UUID 128 
 ...
 scalar_t__ nfsd4_encode_security_label (struct xdr_stream*,struct svc_rqst*,int /*<<< orphan*/ *,int) ; 
