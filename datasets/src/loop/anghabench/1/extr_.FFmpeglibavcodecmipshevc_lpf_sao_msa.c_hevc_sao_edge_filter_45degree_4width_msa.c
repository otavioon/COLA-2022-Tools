...
/* Variables and functions */
 ...
 int /*<<< orphan*/  ILVR_B2_UB (int,scalar_t__,int,scalar_t__,scalar_t__,scalar_t__) ; 
...
__attribute__((used)) static void hevc_sao_edge_filter_45degree_4width_msa(uint8_t *dst,
                                                     int32_t dst_stride,
                                                     uint8_t *src,
                                                     int32_t src_stride,
