...
struct TYPE_22__ {unsigned char* StackTop; int /*<<< orphan*/  (* pfnFree ) (int /*<<< orphan*/ ) ;TYPE_1__* StubDesc; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  NDRSContextValue (int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  NdrAllocate (TYPE_4__*,int /*<<< orphan*/ ) ; 
