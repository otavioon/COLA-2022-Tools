...
struct TYPE_13__ {int len; int /*<<< orphan*/ * buf; } ;
struct TYPE_24__ {int num_curves; int num_values; int /*<<< orphan*/ * curves; int /*<<< orphan*/  lock; } ;
struct fbtft_par {TYPE_12__ fbtftops; TYPE_11__ gpio; TYPE_10__ txbuf; struct fb_info* info; TYPE_9__ gamma; int /*<<< orphan*/  pseudo_palette; int /*<<< orphan*/  const* init_sequence; int /*<<< orphan*/  startbyte; int /*<<< orphan*/  bgr; int /*<<< orphan*/  dirty_lock; int /*<<< orphan*/ * buf; scalar_t__ debug; struct fbtft_platform_data* pdata; } ;
