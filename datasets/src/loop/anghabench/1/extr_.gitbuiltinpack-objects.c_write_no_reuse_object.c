...
struct object_entry {unsigned char* delta_data; long z_delta_size; TYPE_3__ idx; } ;
...
struct TYPE_6__ {unsigned char* hash; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  FREE_AND_NULL (unsigned char*) ; 
 ...
 unsigned long do_compress (unsigned char**,unsigned long) ; 
 unsigned int encode_in_pack_object_header (unsigned char*,int,int,unsigned long) ; 
 int /*<<< orphan*/  free (unsigned char*) ; 
 unsigned char* get_delta (struct object_entry*) ; 
 ...
 unsigned char* read_object_file (int /*<<< orphan*/ *,int*,unsigned long*) ; 
