...
struct TYPE_11__ {scalar_t__* feat_num; int* resc_start; int /*<<< orphan*/  opaque_fid; } ;
...
struct qed_cxt_info {int iid; struct e4_fcoe_conn_context* p_cxt; } ;
...
/* Variables and functions */
 ...
 int qed_cxt_acquire_cid (struct qed_hwfn*,int /*<<< orphan*/ ,int*) ; 
