...
struct TYPE_28__ {int dwFileAttributes; char* cFileName; int nFileSizeHigh; int nFileSizeLow; int /*<<< orphan*/  ftLastWriteTime; int /*<<< orphan*/  ftLastAccessTime; int /*<<< orphan*/  ftCreationTime; } ;
