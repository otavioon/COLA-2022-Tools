...
struct TYPE_13__ {int tif_diroff; int tif_flags; int tif_size; int tif_base; int /*<<< orphan*/  tif_clientdata; int /*<<< orphan*/  tif_name; } ;
...
/* Variables and functions */
 ...
 int TIFF_BIGTIFF ; 
 int TIFF_SWAB ; 
 int* _TIFFCheckMalloc (TYPE_3__*,int,int,char*) ; 
