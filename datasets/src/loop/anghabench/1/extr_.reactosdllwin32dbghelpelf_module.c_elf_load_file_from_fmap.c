...
struct TYPE_22__ {int /*<<< orphan*/ * sh_addr; } ;
struct TYPE_23__ {TYPE_1__ shdr; } ;
struct TYPE_19__ {int BaseOfImage; int /*<<< orphan*/  SymType; } ;
struct TYPE_21__ {int reloc_delta; TYPE_12__ module; struct module_format** format_info; } ;
