...
/* Type definitions */
struct TYPE_17__ {int /*<<< orphan*/  sockaddr; } ;
struct TYPE_20__ {int /*<<< orphan*/ * data; scalar_t__ len; } ;
struct TYPE_19__ {int listen; int default_port; scalar_t__ backlog; int rcvbuf; int sndbuf; int default_server; int set; int bind; int so_keepalive; int proxy_protocol; int /*<<< orphan*/  addr; int /*<<< orphan*/  socklen; TYPE_10__ sockaddr; int /*<<< orphan*/  wildcard; TYPE_3__ url; scalar_t__ err; } ;
typedef  TYPE_2__ ngx_url_t ;
typedef  size_t ngx_uint_t ;
typedef  TYPE_3__ ngx_str_t ;
typedef  TYPE_2__ ngx_http_listen_opt_t ;
struct TYPE_21__ {int listen; } ;
