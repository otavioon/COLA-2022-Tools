...
/* Type definitions */
struct rwm_encrypt_decrypt_tmp {int buf_left; scalar_t__ left; int bp; int /*<<< orphan*/  iv; int /*<<< orphan*/  ctx; int /*<<< orphan*/  (* crypt ) (int /*<<< orphan*/ ,int /*<<< orphan*/  const*,scalar_t__,int,int /*<<< orphan*/ ) ;int /*<<< orphan*/  const* buf; struct raw_message* raw; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  stub1 (int /*<<< orphan*/ ,int /*<<< orphan*/  const*,scalar_t__,int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  stub2 (int /*<<< orphan*/ ,int /*<<< orphan*/  const*,scalar_t__,int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  stub3 (int /*<<< orphan*/ ,int /*<<< orphan*/  const*,scalar_t__,int,int /*<<< orphan*/ ) ; 
