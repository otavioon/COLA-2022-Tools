...
/* Type definitions */
struct TYPE_11__ {int csize; int n_fatent; int /*<<< orphan*/  drv; } ;
struct TYPE_10__ {int err; int fsize; int flag; int fptr; int clust; int sclust; int dsect; TYPE_3__* fs; int /*<<< orphan*/  buf; } ;
