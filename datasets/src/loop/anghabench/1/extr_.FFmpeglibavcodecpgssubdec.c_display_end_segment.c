...
struct TYPE_25__ {int err_recognition; TYPE_5__* priv_data; } ;
struct TYPE_24__ {scalar_t__ pts; TYPE_14__** rects; int /*<<< orphan*/  num_rects; scalar_t__ format; int /*<<< orphan*/  end_display_time; scalar_t__ start_display_time; } ;
struct TYPE_20__ {scalar_t__ pts; int object_count; TYPE_1__* objects; int /*<<< orphan*/  palette_id; } ;
struct TYPE_23__ {TYPE_2__ presentation; int /*<<< orphan*/  forced_subs_only; int /*<<< orphan*/  objects; int /*<<< orphan*/  palettes; } ;
struct TYPE_22__ {int /*<<< orphan*/  rle_data_len; scalar_t__ rle; scalar_t__ rle_remaining_len; int /*<<< orphan*/  w; int /*<<< orphan*/  h; } ;
struct TYPE_21__ {int /*<<< orphan*/  clut; } ;
struct TYPE_19__ {int composition_flag; int /*<<< orphan*/  y; int /*<<< orphan*/  x; int /*<<< orphan*/  id; } ;
struct TYPE_18__ {int nb_colors; void** data; int /*<<< orphan*/  h; int /*<<< orphan*/  w; int /*<<< orphan*/ * linesize; int /*<<< orphan*/  y; int /*<<< orphan*/  x; int /*<<< orphan*/  flags; int /*<<< orphan*/  type; } ;
...
/* Variables and functions */
 ...
 void* av_mallocz (int) ; 
 TYPE_14__** av_mallocz_array (int,int) ; 
 int /*<<< orphan*/  avsubtitle_free (TYPE_6__*) ; 
 int decode_rle (TYPE_7__*,TYPE_14__*,scalar_t__,int /*<<< orphan*/ ) ; 
