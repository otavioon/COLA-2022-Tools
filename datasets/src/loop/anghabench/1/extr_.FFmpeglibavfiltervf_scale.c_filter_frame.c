...
struct TYPE_32__ {int width; int height; scalar_t__ format; int color_range; scalar_t__ interlaced_frame; TYPE_1__ sample_aspect_ratio; int /*<<< orphan*/  colorspace; int /*<<< orphan*/ ** data; } ;
