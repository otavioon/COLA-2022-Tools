...
struct TYPE_27__ {scalar_t__ p; scalar_t__ ep; } ;
struct TYPE_24__ {void* len; void* data; } ;
struct TYPE_26__ {long offset; long reg; TYPE_3__ loc; void* type; } ;
struct TYPE_25__ {long loc; long endloc; long iquantum; long dquantum; int nr; int nstack; TYPE_5__* r; TYPE_2__* cfa; TYPE_5__** stack; TYPE_5__* initr; } ;
struct TYPE_22__ {void* len; void* data; } ;
struct TYPE_23__ {long reg; long offset; TYPE_1__ loc; void* type; } ;
typedef  TYPE_4__ State ;
typedef  TYPE_5__ DwarfExpr ;
typedef  TYPE_6__ DwarfBuf ;

/* Variables and functions */
 int /*<<< orphan*/  RtlMoveMemory (TYPE_5__*,TYPE_5__*,int) ; 
 void* RuleCfaOffset ; 
 void* RuleLocation ; 
 void* RuleRegOff ; 
 void* RuleRegister ; 
