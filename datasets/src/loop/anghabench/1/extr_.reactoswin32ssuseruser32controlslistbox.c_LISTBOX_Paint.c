...
struct TYPE_12__ {size_t page_size; int style; scalar_t__ height; int self; size_t nb_items; int focus_item; scalar_t__ item_height; size_t top_item; scalar_t__ width; scalar_t__ in_focus; scalar_t__ caret_on; scalar_t__ column_width; TYPE_1__* items; int /*<<< orphan*/  owner; scalar_t__ font; scalar_t__ horz_pos; } ;
...
/* Variables and functions */
 ...
 int ETO_CLIPPED ; 
 int ETO_OPAQUE ; 
 int /*<<< orphan*/  ExtTextOutW (int,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int,TYPE_2__*,int /*<<< orphan*/ *,int /*<<< orphan*/ ,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  FALSE ; 
 int /*<<< orphan*/  GetSysColor (int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  IS_OWNERDRAW (TYPE_3__*) ; 
 int /*<<< orphan*/  IsWindowEnabled (int) ; 
 int LBS_MULTICOLUMN ; 
 int LBS_NOREDRAW ; 
 int LBS_OWNERDRAWVARIABLE ; 
 int /*<<< orphan*/  LISTBOX_PaintItem (TYPE_3__*,int,TYPE_2__*,size_t,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 ...
 int /*<<< orphan*/  SetTextColor (int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  SetWindowOrgEx (int,scalar_t__,int /*<<< orphan*/ ,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  TRUE ; 
