...
struct sockaddr_un {char* sun_path; int ai_flags; int ai_addrlen; struct sockaddr* ai_addr; int /*<<< orphan*/  ai_protocol; int /*<<< orphan*/  ai_socktype; int /*<<< orphan*/  ai_family; struct sockaddr_un* ai_next; int /*<<< orphan*/  sun_family; } ;
struct sockaddr {int dummy; } ;
struct listener_config_t {int proxy_protocol; int /*<<< orphan*/ * hosts; } ;
struct addrinfo {char* sun_path; int ai_flags; int ai_addrlen; struct sockaddr* ai_addr; int /*<<< orphan*/  ai_protocol; int /*<<< orphan*/  ai_socktype; int /*<<< orphan*/  ai_family; struct addrinfo* ai_next; int /*<<< orphan*/  sun_family; } ;
...
#define  YOML_TYPE_SCALAR 128 
 struct listener_config_t* add_listener (int,struct sockaddr*,int,int /*<<< orphan*/ ,int) ; 
 TYPE_24__ conf ; 
 struct listener_config_t* find_listener (struct sockaddr*,int) ; 
 int find_listener_from_server_starter (struct sockaddr*) ; 
 ...
 int /*<<< orphan*/  h2o_append_to_null_terminated_list (int /*<<< orphan*/ ,int /*<<< orphan*/ *) ; 
 ...
 int open_tcp_listener (int /*<<< orphan*/ *,TYPE_3__*,char const*,char const*,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ,struct sockaddr*,int) ; 
