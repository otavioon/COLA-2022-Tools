...
struct urb {int transfer_buffer_length; int transfer_flags; int /*<<< orphan*/  pipe; int /*<<< orphan*/  dev; int /*<<< orphan*/ * transfer_buffer; int /*<<< orphan*/ * setup_packet; int /*<<< orphan*/  transfer_dma; } ;
struct oxu_hcd {TYPE_1__* async; } ;
struct list_head {int dummy; } ;
struct ehci_qtd {int buffer_dma; int /*<<< orphan*/  hw_token; int /*<<< orphan*/  qtd_list; int /*<<< orphan*/  qtd_dma; void* hw_next; struct urb* urb; int /*<<< orphan*/  hw_alt_next; int /*<<< orphan*/ * transfer_buffer; int /*<<< orphan*/  buffer; } ;
