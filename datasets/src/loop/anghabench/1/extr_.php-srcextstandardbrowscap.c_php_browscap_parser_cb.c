...
struct TYPE_10__ {int /*<<< orphan*/  kv_used; int /*<<< orphan*/  htab; } ;
typedef  TYPE_1__ browser_data ;
struct TYPE_11__ {int /*<<< orphan*/ * current_section_name; TYPE_3__* current_entry; TYPE_1__* bdata; } ;
typedef  TYPE_2__ browscap_parser_ctx ;
struct TYPE_12__ {size_t prefix_len; int /*<<< orphan*/ * contains_len; int /*<<< orphan*/ * contains_start; int /*<<< orphan*/ * parent; int /*<<< orphan*/  kv_start; int /*<<< orphan*/  kv_end; void* pattern; } ;
