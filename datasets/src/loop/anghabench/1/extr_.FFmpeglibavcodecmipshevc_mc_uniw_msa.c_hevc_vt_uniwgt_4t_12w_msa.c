...
/* Variables and functions */
 int /*<<< orphan*/  HEVC_FILT_4TAP_SH (int,int,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 ...
 int /*<<< orphan*/  ILVRL_B2_SB (int,int,int,int) ; 
 int /*<<< orphan*/  ILVR_B2_SB (int,int,int,int,int,int) ; 
 int /*<<< orphan*/  LD_SB3 (int /*<<< orphan*/ *,int,int,int,int) ; 
 int /*<<< orphan*/  LD_SB8 (int /*<<< orphan*/ *,int,int,int,int,int,int,int,int,int) ; 
 ...
 int /*<<< orphan*/  XORI_B3_128_SB (int,int,int) ; 
 int /*<<< orphan*/  XORI_B8_128_SB (int,int,int,int,int,int,int,int) ; 
