...
/* Type definitions */
struct stripe_head {int disks; int sector; int /*<<< orphan*/  state; TYPE_2__* dev; int /*<<< orphan*/  count; struct r5conf* raid_conf; } ;
struct r5conf {scalar_t__ max_degraded; scalar_t__ max_nr_stripes; TYPE_3__* mddev; TYPE_1__* disks; } ;
struct md_rdev {int new_data_offset; int data_offset; int /*<<< orphan*/  flags; int /*<<< orphan*/  read_errors; int /*<<< orphan*/  bdev; int /*<<< orphan*/  corrected_errors; } ;
...
/* Variables and functions */
 ...
 scalar_t__ rdev_set_badblocks (struct md_rdev*,int,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
