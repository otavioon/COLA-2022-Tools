...
struct TYPE_12__ {int chip_version; int sdtr_enable; int disc_enable; int cmd_qng_enabled; int* adapter_info; int chip_scsi_id; int* max_tag_qng; int /*<<< orphan*/ * sdtr_period_offset; int /*<<< orphan*/  isa_dma_speed; } ;
