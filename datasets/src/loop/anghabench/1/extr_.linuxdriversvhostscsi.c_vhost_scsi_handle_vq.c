...
struct virtio_scsi_cmd_req {int* lun; int task_attr; int /*<<< orphan*/ * cdb; int /*<<< orphan*/  tag; scalar_t__ pi_bytesin; scalar_t__ pi_bytesout; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  WRITE ; 
 int /*<<< orphan*/  copy_from_iter_full (struct virtio_scsi_cmd_req_pi*,size_t,struct iov_iter*) ; 
 ...
 struct vhost_scsi_cmd* vhost_scsi_get_tag (struct vhost_virtqueue*,struct vhost_scsi_tpg*,int /*<<< orphan*/ *,int /*<<< orphan*/ ,int,int,size_t,size_t) ; 
