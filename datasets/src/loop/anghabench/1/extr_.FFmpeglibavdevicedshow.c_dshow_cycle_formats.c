...
struct TYPE_26__ {int nSamplesPerSec; scalar_t__ wBitsPerSample; int nChannels; } ;
typedef  TYPE_4__ WAVEFORMATEX ;
struct TYPE_25__ {int cx; scalar_t__ cy; } ;
struct TYPE_24__ {int cx; scalar_t__ cy; } ;
struct TYPE_27__ {int MaxFrameInterval; int MinFrameInterval; int MinimumChannels; scalar_t__ MinimumBitsPerSample; int MinimumSampleFrequency; int MaximumChannels; scalar_t__ MaximumBitsPerSample; int MaximumSampleFrequency; TYPE_3__ MinOutputSize; TYPE_2__ MaxOutputSize; } ;
typedef  TYPE_5__ VIDEO_STREAM_CONFIG_CAPS ;
struct TYPE_30__ {int biCompression; int biWidth; scalar_t__ biHeight; int /*<<< orphan*/  biBitCount; } ;
struct TYPE_28__ {int AvgTimePerFrame; TYPE_8__ bmiHeader; } ;
typedef  TYPE_6__ VIDEOINFOHEADER2 ;
struct TYPE_29__ {int AvgTimePerFrame; TYPE_8__ bmiHeader; } ;
typedef  TYPE_7__ VIDEOINFOHEADER ;
struct TYPE_31__ {struct dshow_ctx* priv_data; } ;
struct TYPE_22__ {struct TYPE_22__* pbFormat; int /*<<< orphan*/  formattype; } ;
...
typedef  TYPE_5__ AUDIO_STREAM_CONFIG_CAPS ;
...
/* Variables and functions */
 ...
 int IAMStreamConfig_GetStreamCaps (int /*<<< orphan*/ *,int,TYPE_12__**,int /*<<< orphan*/ ) ; 
 ...
 int S_OK ; 
 int VideoDevice ; 
 scalar_t__ av_codec_get_id (int /*<<< orphan*/  const* const*,int) ; 
 ...
 scalar_t__ dshow_pixfmt (int,int /*<<< orphan*/ ) ; 
