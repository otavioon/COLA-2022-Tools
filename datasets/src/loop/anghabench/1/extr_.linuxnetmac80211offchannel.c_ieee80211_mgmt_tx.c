...
struct cfg80211_mgmt_tx_params {scalar_t__ chan; int n_csa_offsets; size_t* csa_offsets; int /*<<< orphan*/  wait; scalar_t__ dont_wait_for_ack; scalar_t__ len; int /*<<< orphan*/ * buf; scalar_t__ offchan; scalar_t__ no_cck; } ;
