...
struct TYPE_16__ {int /*<<< orphan*/  bufs_miss; int /*<<< orphan*/  bufs_vmhits; int /*<<< orphan*/  bufs_incore; int /*<<< orphan*/  bufs_busyincore; } ;
struct TYPE_15__ {int b_lflags; int b_flags; int b_bcount; int b_bufsize; int b_lblkno; int b_datap; int b_blkno; int b_validend; int b_dirtyend; int /*<<< orphan*/  b_dirtyoff; int /*<<< orphan*/  b_validoff; void* b_upl; int /*<<< orphan*/  b_vp; } ;
...
#define  BLK_WRITE 128 
 ...
 int /*<<< orphan*/  KERNEL_DEBUG (int,TYPE_1__*,int,int,int,int /*<<< orphan*/ ) ; 
 int KERN_SUCCESS ; 
 int NSEC_PER_USEC ; 
