...
typedef  int ULONG ;
struct TYPE_10__ {scalar_t__ Address; int /*<<< orphan*/  SourceLine; void* FunctionOffset; void* FileOffset; } ;
struct TYPE_9__ {scalar_t__ n_value; int n_type; int n_strx; int /*<<< orphan*/  n_desc; } ;
...
/* Variables and functions */
 int CompareSymEntry ; 
 void* FindOrAddString (struct StringHashTable*,char*,int*,int /*<<< orphan*/ *) ; 
#define  N_BINCL 132 
#define  N_FUN 131 
#define  N_SLINE 130 
#define  N_SO 129 
