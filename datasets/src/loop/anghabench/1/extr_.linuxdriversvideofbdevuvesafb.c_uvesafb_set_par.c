...
struct vbe_crtc_ib {int horiz_start; int horiz_end; int horiz_total; int vert_start; int vert_end; int vert_total; int pixel_clock; int flags; int /*<<< orphan*/  refresh_rate; } ;
